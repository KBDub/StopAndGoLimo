...
|---|---|---|---|---|---|---|
| **Overview** | Custom Apparel | `/custom-apparel` | ✅ Exists | N | 12 | |
| **Printing Options** | | | | | | |
| | Direct to Film (DTF) | `/custom-apparel/dtf-transfers` | ✅ Exists | N | 11 | |
| | Dye-Sublimation | `/custom-apparel/dye-sublimation` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Screen Printing | `/custom-apparel/screen-printing` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Embroidery | `/custom-apparel/embroidery` | ✅ Exists | N | 11 | URL changed from `/embroidery-shirts` → `/embroidery` (may add sub-sub pages) |
| | Rhinestone | `/custom-apparel/rhinestone-shirts` | ✅ Exists | N | 11 | |
| | Digital Vinyl | `/custom-apparel/vinyl-shirts` | ✅ Exists | N | 11 | |
| **Specialty Materials** | | | | | | |
| | Glitter | `/custom-apparel/glitter-shirts` | ✅ Exists | N | 11 | |
| | Puff | `/custom-apparel/puff-shirts` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Glow in the Dark | `/custom-apparel/glow-in-the-dark-shirts` | ✅ Exists | N | 11 | |
| | Flock | `/custom-apparel/flock-shirts` | ✅ Exists | N | 11 | |
| | Brick | `/custom-apparel/brick-shirts` | ✅ Exists | N | 11 | |
| | Holographic | `/custom-apparel/holographic-shirts` | ✅ Exists | N | 11 | |
| | Foil | `/custom-apparel/foil-shirts` | ✅ Exists | N | 11 | |
| | Reflective | `/custom-apparel/reflective-shirts` | ✅ Exists | N | 11 | |
| **Group Shirts** | | | | | | |
| | Family Reunion | `/custom-apparel/reunion-shirts` | ✅ Exists | N | 15 | |
| | Spirit Wear | `/custom-apparel/spirit-wear-shirts` | ✅ Exists | N | 15 | URL changed from `/spirit-wear` → `/spirit-wear-shirts` |
| | Corporate Wear | `/custom-apparel/corporate-wear-shirts` | ✅ Exists | N | 15 | URL changed from `/corporate-wear` → `/corporate-wear-shirts` |
...
| Category Title | Sub-link | URL | Page Status | Needs Sections | Sections | Notes |
|---|---|---|---|---|---|---|
| **Overview** | Select a Sign | `/signs` | ✅ Exists | N | 12 | |
| **Business Signs** | | | | | | |
| | Banners | `/signs/banners` | ✅ Exists | N | 15 | |
| | Window Signs | `/signs/window-signs` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Wall Signs | `/signs/wall-signs` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Floor Signs | `/signs/floor-signs` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Door Signs | `/signs/door-signs` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Posters | `/signs/posters` | ✅ Exists | N | 15 | |
| **Ground Signs** | | | | | | |
| | Yard Signs | `/signs/yard-signs` | ✅ Exists | Y | 15 | |
| | A-Frame / Sidewalk Signs | `/signs/sidewalk-signs` | ✅ Exists | Y | 14 | |
| | Parking Signs | `/signs/parking-signs` | ✅ Exists | N | 12 | Page was built — needs section review |
| **Table Signs** | | | | | | |
| | Table Cloths | `/signs/table-cloths` | ✅ Exists | N | 12 | Page was built — needs section review |
| | Table Runners | `/signs/table-runners` | ✅ Exists | Y | 15 | |
...
| Category Title | Sub-link | URL | Page Status | Needs Sections | Sections | Notes |
|---|---|---|---|---|---|---|
| **Overview** | Promotional Items | `/promotional-items` | ✅ Exists | N | 10 | |
| **Promo Products** | | | | | | |
| | Mugs | `/promotional-items/mugs` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Can Koozies | `/promotional-items/can-koozies` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Towels | `/promotional-items/towels` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Drink Coasters | `/promotional-items/drink-coasters` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Drawstring / Tote Bags | `/promotional-items/tote-bags` | ✅ Exists | Y | 12 | Page was built — needs section review |
| | Mouse Pads | `/promotional-items/mouse-pads` | ✅ Exists | Y | 12 | Page was built — needs section review |
...
| URL | Sections | Notes |
|---|---|---|
| `/` (Home) | 17 | Top-level nav item but has no dropdown table — intentional |
| `/cart` | 2 | Utility page — no nav entry needed |
| `/checkout` | 2 | Utility page — no nav entry needed |
| `/order-confirmation` | 2 | Utility page — no nav entry needed |
| `/page-management` | 5 | Admin tool — no nav entry needed |
| `/collection` | 10 | Dynamic template (`pages/collection.blade.php`) — rendered via `/collections/{slug}` route |
| `/product` | 9 | Dynamic template (`pages/product.blade.php`) — rendered via `/products/{slug}` route |
| `/contact` | 9 | Exists but not in mega menu — needs a decision: add to About Us dropdown or footer-only |
| `/stores` | 9 | Exists but not in mega menu — needs a decision |
...
|---|---|---|---|
| `/custom-apparel/embroidery-shirts` | 11 | `/custom-apparel/embroidery` | Delete old file |
| `/custom-apparel/spirit-wear` | 15 | `/custom-apparel/spirit-wear-shirts` | Delete old file |
| `/custom-apparel/corporate-wear` | 15 | `/custom-apparel/corporate-wear-shirts` | Delete old file |
...
| URL | Sections | Notes |
|---|---|---|
| `/custom-apparel/custom-shirts` | 18 | General custom shirts landing — heaviest page (18 components) |
| `/custom-apparel/pattern-shirts` | 11 | |
| `/custom-apparel/picture-shirts` | 11 | |
...
|---|---|---|---|
| `/decals` (index) | 12 | Removed from nav (Stickers promoted) | Decide: keep, redirect, or delete |
| `/decals/stickers` | 15 | `/stickers/standard-stickers` | Redirect + delete after refactor confirmed |
| `/decals/window-wall-floor-decals` | 15 | No replacement planned | Decide: add to signs, or delete |
| `/decals/coronavirus-decals` | 12 | No replacement planned | Decide: keep for SEO or delete |
| `/design-it-yourself` (index) | 10 | `/design-services` | Redirect + delete after refactor confirmed |
| `/design-it-yourself/online-designer` | 10 | `/design-services/online-designer` | Redirect + delete after refactor confirmed |
| `/design-it-yourself/design-catalogs` | 10 | `/design-services/design-catalogs` | Redirect + delete after refactor confirmed |
