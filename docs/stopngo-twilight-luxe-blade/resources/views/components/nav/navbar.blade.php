{{--
  ...
  theme extension. Routes below are placeholders matching the live URLs —
...
<header class="bg-navy">
    ...
    <nav class="flex flex-wrap items-center gap-1.5 px-[18px]" aria-label="Primary">
        <a href="/" class="font-head font-bold text-base text-white px-[18px] py-5 pl-1.5 mr-auto no-underline">
            Stop &amp; Go <span class="text-champagne">Limo</span>
        </a>
        ...
        <x-nav.link href="/bookings-reservations">Booking</x-nav.link>
        ...
        <x-nav.link href="/get-a-quote">Contact</x-nav.link>
    </nav>
</header>
