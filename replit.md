...
-   **Typography Scale Increase (Mar 2026):** All non-H1 font sizes bumped up one level for improved readability. H1 unchanged at 32px/28px. New scale: H2=28px, H3=24px, H4=20px, H5=18px, Body=18px, Body Small=16px, Caption=14px, Button/Nav=16px. Updated in `resources/css/app.css`, `tailwind.config.js`, and `docs/branding-requirements.md`.
