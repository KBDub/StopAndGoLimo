<footer class="bg-linen text-charcoal py-8 border-t border-linen-dark">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row gap-6 mb-6 items-start">
            ...
            {{-- Logo --}}
            <div id="logo" class="shrink-0 w-44">
            ...
            {{-- Quick Links --}}
            <div id="quick-links" class="shrink-0 w-36">
                ...
                <ul class="space-y-1.5 text-xs">
                    ...
                    <li>
                        <a href="#"
                           ...
                           class="text-azure hover:text-azure-dark border-b-2 border-azure/30 hover:border-azure pb-px transition-all no-underline">
                            Contact Us
                        </a>
                    </li>
                </ul>
            ...
            {{-- Services — 4 sub-columns, takes all remaining space --}}
            <div id="services" class="flex-1 min-w-0">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-x-3 gap-y-4">
                    ...
                    {{-- Apparel --}}
                    <div>
                        <h5 class="font-semibold text-charcoal text-xs uppercase tracking-wide mb-2">
                    ...
                    <div>
                        ...
                        <ul class="space-y-1 text-xs mb-3">
                            <li><a href="/vehicle-graphics/automobile-graphics" class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Automobile Graphics</a></li>
                            <li><a href="/vehicle-graphics/vehicle-magnets"     class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Vehicle Magnets</a></li>
                            <li><a href="/vehicle-graphics/dot-decals"          class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">DOT Decals</a></li>
                        </ul>
                        <h5 class="font-semibold text-charcoal text-xs uppercase tracking-wide mb-2">
                    ...
                    <div>
                        ...
                        <ul class="space-y-1 text-xs mb-3">
                            <li><a href="/promotional-items/mugs"           class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Mugs</a></li>
                            <li><a href="/promotional-items/can-koozies"    class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Can Koozies</a></li>
                            <li><a href="/promotional-items/tote-bags"      class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Tote Bags</a></li>
                            <li><a href="/promotional-items/towels"         class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Towels</a></li>
                            <li><a href="/promotional-items/mouse-pads"     class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Mouse Pads</a></li>
                            <li><a href="/promotional-items/drink-coasters" class="text-azure hover:text-azure-dark border-b border-azure/30 hover:border-azure pb-px transition-all no-underline">Drink Coasters</a></li>
                        </ul>
                        <h5 class="font-semibold text-charcoal text-xs uppercase tracking-wide mb-2">
            ...
            {{-- Contact --}}
            <div id="contact" class="shrink-0 w-44">
                ...
                <div class="text-xs space-y-2">
                    ...
                    <p>
                        <a href="tel:+18153498600" class="text-azure hover:text-azure-dark border-b-2 border-azure/30 hover:border-azure pb-px transition-all no-underline">
                            (815) 349-8600
                        </a>
                    </p>
                </div>
