    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex items-center gap-4 transition-all duration-300 h-14 lg:h-20" x-bind:class="scrolled ? 'h-12 lg:h-14' : 'h-14 lg:h-20'">
            ...
            <div class="flex-1 flex md:hidden justify-center items-center gap-2">
                <a href="https://www.google.com/maps?cid=15797523837573086431" target="_blank" rel="noopener" aria-label="Google Maps" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
                ...
                <a href="https://www.facebook.com/top5percent/" target="_blank" rel="noopener" aria-label="Facebook" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.instagram.com/top5percentllc/" target="_blank" rel="noopener" aria-label="Instagram" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
                ...
                <a href="https://www.pinterest.com/top5percentllc/" target="_blank" rel="noopener" aria-label="Pinterest" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
                ...
                <a href="https://www.youtube.com/channel/UCAhLYjgb9745wv_yfmxSe6w/" target="_blank" rel="noopener" aria-label="YouTube" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
                ...
                <a href="https://www.twitter.com/top5percentllc/" target="_blank" rel="noopener" aria-label="X (Twitter)" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
                ...
                <a href="https://www.linkedin.com/in/top5percent/" target="_blank" rel="noopener" aria-label="LinkedIn" class="text-cloud opacity-60 hover:opacity-100 hover:scale-125 hover:text-champagne transition-all duration-200">
            ...
            <div class="hidden md:flex flex-1 self-stretch items-stretch justify-between relative z-50">
                ...
                <div class="relative self-stretch flex items-stretch">
                    <a href="/" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center {{ $currentPage === 'home' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">Home</a>
                </div>
                ...
                >
                    <a href="/custom-apparel" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'custom-apparel' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Custom Apparel
                ...
                <div
                    ...
                    @mouseleave="openMenu = null"
                >
                    <a href="/signs" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'signs' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Select a Sign
                ...
                <div
                    ...
                    @mouseleave="openMenu = null"
                >
                    <a href="/stickers" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'stickers' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Stickers
                ...
                <div
                    ...
                    @mouseleave="openMenu = null"
                >
                    <a href="/vehicle-graphics" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'vehicle-graphics' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Vehicle Decals
                ...
                <div
                    ...
                    @mouseleave="openMenu = null"
                >
                    <a href="/promotional-items" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'promotional-items' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Promo Items
                ...
                <div class="self-stretch flex items-stretch">
                    <a href="/top5pct-merchandise" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center {{ $currentPage === 'merchandise' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Top 5% Merchandise
                    </a>
                </div>
                ...
                <div
                    ...
                    @mouseleave="openMenu = null"
                >
                    <a href="/design-services" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'design-services' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        Design Services
                ...
                <div
                    ...
                    @mouseleave="openMenu = null"
                >
                    <a href="/about-us" class="px-2 h-full text-lg font-semibold leading-tight text-center inline-flex items-center gap-0.5 {{ $currentPage === 'about' ? 'text-champagne' : 'text-cloud hover:text-champagne' }} transition-colors">
                        About Us
