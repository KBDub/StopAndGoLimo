                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="pb-2 border-b border-linen-dark">
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            <div><a href="/custom-apparel/dtf-transfers" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Direct to Film (DTF)</a><a href="/custom-apparel/dtf-transfers" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">High-detail heat transfers</a></div>
                                            <div><a href="/custom-apparel/dye-sublimation" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Dye-Sublimation</a><a href="/custom-apparel/dye-sublimation" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Edge-to-edge full color</a></div>
                                            <div><a href="/custom-apparel/screen-printing" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Screen Printing</a><a href="/custom-apparel/screen-printing" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Classic bulk production</a></div>
                                            <div><a href="/custom-apparel/embroidery" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Embroidery</a><a href="/custom-apparel/embroidery" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Premium stitched branding</a></div>
                                            <div><a href="/custom-apparel/rhinestone-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Rhinestone</a><a href="/custom-apparel/rhinestone-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Crystal embellishments</a></div>
                                            <div><a href="/custom-apparel/vinyl-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Digital Vinyl</a><a href="/custom-apparel/vinyl-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Sharp, durable graphics</a></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pb-2 border-b border-linen-dark">
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            <div><a href="/custom-apparel/glitter-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Glitter</a><a href="/custom-apparel/glitter-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Shimmer and sparkle</a></div>
                                            <div><a href="/custom-apparel/puff-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Puff</a><a href="/custom-apparel/puff-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Raised 3D texture</a></div>
                                            <div><a href="/custom-apparel/glow-in-the-dark-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Glow in the Dark</a><a href="/custom-apparel/glow-in-the-dark-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Luminous night effects</a></div>
                                            <div><a href="/custom-apparel/flock-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Flock</a><a href="/custom-apparel/flock-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Velvet-like soft feel</a></div>
                                            <div><a href="/custom-apparel/brick-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Brick</a><a href="/custom-apparel/brick-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Extra thick, bold look</a></div>
                                            <div><a href="/custom-apparel/holographic-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Holographic</a><a href="/custom-apparel/holographic-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Iridescent color shifting</a></div>
                                            <div><a href="/custom-apparel/foil-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Foil</a><a href="/custom-apparel/foil-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Shiny metallic finish</a></div>
                                            <div><a href="/custom-apparel/reflective-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Reflective</a><a href="/custom-apparel/reflective-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">High-visibility safety</a></div>
                                        </div>
                                    </div>
                                    {{-- Row 3: Group Shirts --}}
                                    <div>
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            <div><a href="/custom-apparel/reunion-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Family Reunion</a><a href="/custom-apparel/reunion-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Custom matching apparel</a></div>
                                            <div><a href="/custom-apparel/spirit-wear-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Spirit Wear</a><a href="/custom-apparel/spirit-wear-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">School and sports fans</a></div>
                                            <div><a href="/custom-apparel/corporate-wear-shirts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Corporate Wear</a><a href="/custom-apparel/corporate-wear-shirts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Branded staff uniforms</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 pl-5 py-5 min-w-0">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="pb-2 border-b border-linen-dark">
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            <div><a href="/signs/banners" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Banners</a><a href="/signs/banners" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Custom vinyl banners</a></div>
                                            <div><a href="/signs/window-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Window Signs</a><a href="/signs/window-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Storefront decals & perf</a></div>
                                            <div><a href="/signs/wall-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Wall Signs</a><a href="/signs/wall-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Interior murals & graphics</a></div>
                                            <div><a href="/signs/floor-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Floor Signs</a><a href="/signs/floor-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Durable surface branding</a></div>
                                            <div><a href="/signs/door-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Door Signs</a><a href="/signs/door-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Hours & office identifiers</a></div>
                                            <div><a href="/signs/posters" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Posters</a><a href="/signs/posters" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Large format printing</a></div>
                                        </div>
                                    </div>
                                    {{-- Row 2: Ground Signs --}}
                                    <div class="pb-2 border-b border-linen-dark">
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            <div><a href="/signs/yard-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Yard Signs</a><a href="/signs/yard-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Corrugated wire-stake signs</a></div>
                                            <div><a href="/signs/sidewalk-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">A-Frame/Sidewalk Signs</a><a href="/signs/sidewalk-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Portable sandwich boards</a></div>
                                            <div><a href="/signs/parking-signs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Parking Signs</a><a href="/signs/parking-signs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Aluminum & compliance signs</a></div>
                                        </div>
                                    </div>
                                    {{-- Row 3: Table Signs --}}
                                    <div>
                                        ...
                                        <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                            <div><a href="/signs/table-cloths" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Table Cloths</a><a href="/signs/table-cloths" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Full-color branded covers</a></div>
                                            <div><a href="/signs/table-runners" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Table Runners</a><a href="/signs/table-runners" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Accent event branding</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <div class="flex items-stretch bg-white shadow-gold-xl border-t-[6px] border-sunburst">
                            <div class="flex-1 pl-5 py-5 min-w-0">
                                ...
                                <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                    <div><a href="/stickers/standard-stickers" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Standard</a><a href="/stickers/standard-stickers" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Round, square, and rectangle</a></div>
                                    <div><a href="/stickers/custom-shaped-stickers" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Custom Shaped</a><a href="/stickers/custom-shaped-stickers" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Die cut to any design shape</a></div>
                                </div>
                            </div>
                            <x-layout.mega-menu-ad
                    ...
                    >
                        <div class="flex items-stretch bg-white shadow-gold-xl border-t-[6px] border-sunburst">
                            <div class="flex-1 pl-5 py-5 min-w-0">
                                ...
                                <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                    <div><a href="/vehicle-graphics/automobile-graphics" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Automobile Graphics</a><a href="/vehicle-graphics/automobile-graphics" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Full wraps & vinyl lettering</a></div>
                                    <div><a href="/vehicle-graphics/vehicle-magnets" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Vehicle Magnets</a><a href="/vehicle-graphics/vehicle-magnets" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Removable magnetic signs</a></div>
                                    <div><a href="/vehicle-graphics/dot-decals" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">DOT Decals</a><a href="/vehicle-graphics/dot-decals" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Compliant number lettering</a></div>
                                </div>
                            </div>
                            <x-layout.mega-menu-ad
                    ...
                    >
                        <div class="flex items-stretch bg-white shadow-gold-xl border-t-[6px] border-sunburst">
                            <div class="flex-1 pl-5 py-5 min-w-0">
                                ...
                                <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                    <div><a href="/promotional-items/mugs" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Mugs</a><a href="/promotional-items/mugs" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Full color sublimation</a></div>
                                    <div><a href="/promotional-items/can-koozies" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Can Koozies</a><a href="/promotional-items/can-koozies" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Branded foam & neoprene</a></div>
                                    <div><a href="/promotional-items/towels" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Towels</a><a href="/promotional-items/towels" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Beach & sport towels</a></div>
                                    <div><a href="/promotional-items/drink-coasters" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Drink Coasters</a><a href="/promotional-items/drink-coasters" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Ceramic, neoprene, board</a></div>
                                    <div><a href="/promotional-items/tote-bags" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Drawstring/Tote Bags</a><a href="/promotional-items/tote-bags" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Branded canvas bags</a></div>
                                    <div><a href="/promotional-items/mouse-pads" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Mouse Pads</a><a href="/promotional-items/mouse-pads" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Full-surface desk pads</a></div>
                                </div>
                            </div>
                            <x-layout.mega-menu-ad
                                image="/images/stickers-decals/top5pct-stickers-decals-joliet-labels.jpg"
                    ...
                    >
                        <div class="flex items-stretch bg-white shadow-gold-xl border-t-[6px] border-sunburst">
                            <div class="flex-1 pl-5 py-5 min-w-0">
                                ...
                                <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                    <div><a href="/design-services/logo-design" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Logo Design</a><a href="/design-services/logo-design" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Concept to final files</a></div>
                                    <div><a href="/design-services/graphic-design" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Layout/Graphic Design</a><a href="/design-services/graphic-design" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Online designer & catalogs</a></div>
                                    <div><a href="/design-services/custom-storefronts" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Custom Storefronts</a><a href="/design-services/custom-storefronts" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Branded stores for schools & businesses</a></div>
                                </div>
                            </div>
                            <x-layout.mega-menu-ad
                    ...
                    >
                        <div class="flex items-stretch bg-white shadow-gold-xl border-t-[6px] border-sunburst">
                            <div class="flex-1 pl-5 py-5 min-w-0">
                                ...
                                <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                                    <div><a href="/about" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">About Us</a><a href="/about" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Our mission & team</a></div>
                                    <div><a href="/company" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Company</a><a href="/company" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Veteran-owned story</a></div>
                                    <div><a href="/portfolio" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Portfolio</a><a href="/portfolio" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">View our past work</a></div>
                                    <div><a href="/resources" class="block text-base font-bold text-charcoal hover:text-sunburst transition-colors text-center">Resources</a><a href="/resources" class="block text-sm text-charcoal-light leading-tight hover:text-sunburst transition-colors text-center">Tips & helpful guides</a></div>
                                </div>
                            </div>
                            <x-layout.mega-menu-ad
