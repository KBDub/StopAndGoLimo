    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between transition-all duration-300" x-bind:class="scrolled ? 'py-1' : 'py-2'">
            ...
            <div class="hidden lg:flex items-center space-x-1">
                ...
                <a href="https://blackdollbytop5.com/" target="_blank" rel="noopener noreferrer" class="px-3 py-2 text-base font-semibold text-charcoal hover:text-pink-300 transition-colors text-center">
                    Black Doll Apparel
                </a>
