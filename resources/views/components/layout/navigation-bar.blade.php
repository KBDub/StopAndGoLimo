...
>
    ...
    {{-- ===================================================================
         MEGA MENU PANELS
         Structure per panel:
           [Left: dark image panel]  |  [Right: Overview row + 2-col groups]
         ================================================================== --}}
    ...
    {{-- ── Reusable panel wrapper macro (via inline structure per panel) ── --}}
    ...
    <div
        ...
        @mouseenter="openMenu = 'apparel'" @mouseleave="openMenu = null"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            ...
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:260px; background-color:var(--color-charcoal)">
                <img src="/images/custom-shirts/top5pct-banner-custom-apparel-custom-shirts-custom-hoodies-custom-caps.jpg" alt="Custom apparel in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
    ...
    <div
        ...
        @mouseenter="openMenu = 'signs'" @mouseleave="openMenu = null"
        x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 -translate-y-1"
        x-transition:enter-end="opacity-100 translate-y-0"
        x-transition:leave="transition ease-in duration-150"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:260px; background-color:var(--color-charcoal)">
                <img src="/images/window-wall-floor-decals/top5pct-banner-wall-decal-door-signs-joliet.jpg" alt="Custom signs in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
                <div class="absolute inset-0 flex flex-col justify-end p-5">
    ...
    <div
        ...
        @mouseenter="openMenu = 'stickers'" @mouseleave="openMenu = null"
        x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 -translate-y-1"
        x-transition:enter-end="opacity-100 translate-y-0"
        x-transition:leave="transition ease-in duration-150"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:220px; background-color:var(--color-charcoal)">
                <img src="/images/stickers-decals/top5pct-banner-stickers-decals-joliet.jpg" alt="Custom stickers in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
                <div class="absolute inset-0 flex flex-col justify-end p-5">
            ...
            <div class="flex-1 px-8 py-6">
                ...
                <div class="grid grid-cols-2 gap-x-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div><p class="text-sm font-bold text-charcoal">No Minimum Order</p><p class="text-xs text-charcoal-light mt-0.5">Order exactly what you need, one or a thousand</p></div>
                            <div><p class="text-sm font-bold text-charcoal">Weatherproof Vinyl</p><p class="text-xs text-charcoal-light mt-0.5">UV-resistant, waterproof, built to last outdoors</p></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div
        ...
        @mouseenter="openMenu = 'vehicle'" @mouseleave="openMenu = null"
        x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 -translate-y-1"
        x-transition:enter-end="opacity-100 translate-y-0"
        x-transition:leave="transition ease-in duration-150"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:220px; background-color:var(--color-charcoal)">
                <img src="/images/automobile-graphics/top5pct-banner-vinyl-lettering-car-wraps-joliet.jpg" alt="Vehicle wraps and decals in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
                <div class="absolute inset-0 flex flex-col justify-end p-5">
            ...
            <div class="flex-1 px-8 py-6">
                ...
                <div class="grid grid-cols-2 gap-x-8">
                    <div>
                        ...
                        <div class="space-y-3">
                            <div><a href="/vehicle-graphics/automobile-graphics" class="block text-sm font-bold text-charcoal hover:text-sunburst transition-colors">Automobile Graphics & Wraps</a><p class="text-xs text-charcoal-light mt-0.5">Full wraps and vinyl lettering for any vehicle</p></div>
    ...
    <div
        ...
        @mouseenter="openMenu = 'promo'" @mouseleave="openMenu = null"
        x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 -translate-y-1"
        x-transition:enter-end="opacity-100 translate-y-0"
        x-transition:leave="transition ease-in duration-150"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:260px; background-color:var(--color-charcoal)">
                <img src="/images/stickers-decals/top5pct-stickers-decals-joliet-labels.jpg" alt="Branded promotional products in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
                <div class="absolute inset-0 flex flex-col justify-end p-5">
                ...
                <div class="grid grid-cols-2 gap-x-8">
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div><a href="/promotional-items/drink-coasters" class="block text-sm font-bold text-charcoal hover:text-sunburst transition-colors">Drink Coasters</a><p class="text-xs text-charcoal-light mt-0.5">Ceramic, neoprene, and hardboard options</p></div>
                        </div>
                    </div>
                    <div>
    ...
    <div
        ...
        @mouseenter="openMenu = 'design'" @mouseleave="openMenu = null"
        x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 -translate-y-1"
        x-transition:enter-end="opacity-100 translate-y-0"
        x-transition:leave="transition ease-in duration-150"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:220px; background-color:var(--color-charcoal)">
                <img src="/images/custom-shirts/top5pct-custom-embroidery-shops-near-me-joliet.jpg" alt="Professional design services in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
                <div class="absolute inset-0 flex flex-col justify-end p-5">
    ...
    <div
        ...
        @mouseenter="openMenu = 'about'" @mouseleave="openMenu = null"
        x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 -translate-y-1"
        x-transition:enter-end="opacity-100 translate-y-0"
        x-transition:leave="transition ease-in duration-150"
    ...
    >
        <div class="max-w-7xl mx-auto flex items-stretch">
            <div class="relative w-52 flex-shrink-0 overflow-hidden" style="min-height:220px; background-color:var(--color-charcoal)">
                <img src="/images/about-preview.jpg" alt="Top 5 Percent veteran owned shop in Joliet IL" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy">
                <div class="absolute inset-0 flex flex-col justify-end p-5">
