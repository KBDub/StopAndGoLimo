    ...
    <div class="max-w-7xl mx-auto px-4 flex items-center gap-4">
        ...
        <div class="flex-1 flex items-center gap-3 whitespace-nowrap">
            ...
            <div class="flex items-center gap-1.5 mx-auto shrink-0">
                ...
                {{-- Google Maps --}}
                <a href="https://www.google.com/maps?cid=15797523837573086431" target="_blank" rel="noopener" aria-label="Google Maps" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                ...
                {{-- Facebook --}}
                <a href="https://www.facebook.com/top5percent/" target="_blank" rel="noopener" aria-label="Facebook" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {{-- Instagram --}}
                <a href="https://www.instagram.com/top5percentllc/" target="_blank" rel="noopener" aria-label="Instagram" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {{-- Pinterest --}}
                <a href="https://www.pinterest.com/top5percentllc/" target="_blank" rel="noopener" aria-label="Pinterest" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {{-- YouTube --}}
                <a href="https://www.youtube.com/channel/UCAhLYjgb9745wv_yfmxSe6w/" target="_blank" rel="noopener" aria-label="YouTube" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {{-- X (Twitter) --}}
                <a href="https://www.twitter.com/top5percentllc/" target="_blank" rel="noopener" aria-label="X (Twitter)" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {{-- LinkedIn --}}
                <a href="https://www.linkedin.com/in/top5percent/" target="_blank" rel="noopener" aria-label="LinkedIn" class="opacity-70 hover:opacity-100 hover:scale-125 hover:[color:var(--color-olive)] transition-all duration-200">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
