...
<section id="category-hero" class="relative flex items-center justify-center overflow-hidden isolate" style="min-height: 100svh; scroll-margin-top: 80px;">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
        ...
        @if($description)
            <p class="font-body font-bold text-white max-w-5xl mx-auto mb-7" style="font-size: 1.25rem; line-height: 1.5; letter-spacing: -0.4px; text-align: right; text-shadow: var(--text-shadow-subtle); opacity: 0.95;">
                {{ $description }}
            </p>
        @endif
