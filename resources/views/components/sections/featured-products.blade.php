        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div x-data="{ open: false }">
                <x-ui.card-product
                    ...
                    link="/custom-apparel/custom-shirts"
                    linkText="view more"
                >
                    ...
                    <div x-show="open" x-collapse>
                        <p class="text-sm text-charcoal-light mt-2">
                            We use only premium blanks and the latest printing technology to ensure vibrant, long-lasting prints that won't crack or fade. From single custom shirts to bulk orders of 500+, our expert team handles every detail. Same day service available for select orders. Serving Joliet, Plainfield, Shorewood, and all of Will County.
                        </p>
                    </div>
            ...
            <div x-data="{ open: false }">
                <x-ui.card-product
                    ...
                    image="/images/place-holder.1x1.jpg"
                    link="/custom-apparel/corporate-wear"
                    linkText="view more"
                >
                    <p class="text-sm text-charcoal-light mb-1">
                    ...
                    <div x-show="open" x-collapse>
                        <p class="text-sm text-charcoal-light mt-2">
                            Top 5 Percent works with businesses across Will County to create cohesive, professional uniforms and branded apparel. We offer a wide range of styles, colors, and sizes. Whether you need 10 polos or 200 jackets, we provide competitive pricing and consistent quality. Perfect for restaurants, contractors, offices, and retail teams.
                        </p>
                    </div>
                    <button @click="open = !open" class="text-azure hover:text-azure-dark text-sm font-semibold mt-2 cursor-pointer">
                        <span x-text="open ? '... view less' : '... view more'"></span>
            ...
            <div x-data="{ open: false }">
                ...
                >
                    ...
                    <div x-show="open" x-collapse>
                        <p class="text-sm text-charcoal-light mt-2">
                            At Top 5 Percent, we understand that your sign is often the first impression a customer has of your business. We offer a full range of commercial signage solutions including window graphics, A-frame signs, dimensional letters, and illuminated signs. Locally designed and produced right here in Joliet, IL.
                        </p>
                    </div>
                    <button @click="open = !open" class="text-azure hover:text-azure-dark text-sm font-semibold mt-2 cursor-pointer">
                        <span x-text="open ? '... view less' : '... view more'"></span>
            ...
            <div x-data="{ open: false }">
                <x-ui.card-product
                    ...
                    image="/images/place-holder.1x1.jpg"
                    link="/vehicle-graphics/automobile-graphics"
                    linkText="view more"
                >
                    <p class="text-sm text-charcoal-light mb-1">
            ...
            <div x-data="{ open: false }">
                <x-ui.card-product
                    title="DTF Transfers"
                    image="/images/place-holder.1x1.jpg"
                    link="/custom-apparel/dtf-transfers"
                    linkText="view more"
                >
                    <p class="text-sm text-charcoal-light mb-1">
                    ...
                    <div x-show="open" x-collapse>
                        <p class="text-sm text-charcoal-light mt-2">
                            DTF (Direct to Film) is the latest technology in custom apparel printing. Unlike screen printing, there are no minimum order requirements and no color limitations. Your design is printed onto a special film and heat pressed onto garments for a soft, flexible finish. Top 5 Percent offers gang sheets and custom DTF transfers for DIY crafters and businesses alike.
                        </p>
                    </div>
                    <button @click="open = !open" class="text-azure hover:text-azure-dark text-sm font-semibold mt-2 cursor-pointer">
                        <span x-text="open ? '... view less' : '... view more'"></span>
