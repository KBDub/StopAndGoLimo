...
<div style="position: relative; overflow: hidden;">
    ...
    <div class="hidden md:block" style="position:absolute;top:1.5rem;bottom:1.5rem;right:3rem;width:40%;z-index:10;border:0;border-left:4px solid var(--champagne);">
        <iframe
            src="{{ $mapSrc }}"
            width="100%"
            height="100%"
