...
{{-- ── Top: image left / map right ── --}}
<div class="grid grid-cols-1 md:grid-cols-2" style="min-height: 360px;">

    {{-- Left: car image with overlay + social --}}
    <div style="position: relative; min-height: 320px; overflow: hidden;">
        ...
        <div style="position: relative; z-index: 1; padding: 3rem 2.5rem; height: 100%; display: flex; flex-direction: column; justify-content: flex-end; gap: 1.75rem;">
    ...
    <div style="min-height: 320px;">
        <iframe
            ...
            width="100%"
            height="100%"
            style="display: block; border: 0; min-height: 320px;"
            allowfullscreen=""
            loading="lazy"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p style="font-family: var(--font-body); font-size: 0.9rem; color: var(--cloud-light); line-height: 1.7; margin: 0;">
                    <strong style="display: block; margin-bottom: 0.25rem; color: var(--cloud-light);">{{ $businessName }}</strong>
                    {{ $address }}
                </p>
            </div>
