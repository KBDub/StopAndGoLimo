...
{{--
    ...
    H2  — "Why One Bus Beats a Caravan of Cars"
      H3 — "The Group Stays Together" (4-item checklist, left)
      H3 — "Flexible Scheduling for Any Evening" (prose + CTA, right)
        H4 — CTA block with button + phone

    Voice-search SEO: answers "why rent a party bus instead of multiple ubers?"
    and "can a party bus do multiple stops in Chicago?"
    ─────────────────────────────────────────────────────────────────────────────
    Props
      id  string  Section id attribute. Defaults to 'party-bus-advantage'.
--}}
...
<section id="{{ $id }}" style="background: var(--navy); scroll-margin-top: 80px;">
    <div class="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            {{-- ── Right: Flexible scheduling + CTA ───────────────────────── --}}
            <div>
                <h3 style="font-family: var(--font-head); font-size: var(--font-size-h3); color: var(--champagne); font-weight: 600; letter-spacing: 0.01em;" class="mb-6">
                    Flexible Scheduling for Any Evening
                </h3>
                ...
                <div style="border-top: 1px solid rgba(255,255,255,0.12); padding-top: 1.5rem;">
                    <h4 style="font-family: var(--font-head); font-weight: 600; color: var(--white); font-size: 1rem; letter-spacing: 0.03em;" class="mb-4">
                        Ready to book your party bus limo bus?
                    </h4>
                    <p style="font-family: var(--font-body); font-size: 0.95rem; color: var(--slate); line-height: 1.7;" class="mb-6">
                        Get your flat-rate quote in minutes. We serve all of Chicagoland and are available 24 hours a day.
                    </p>
