...
{{--
    ...
    H2  — "One Bus for Every Type of Celebration"
      H3 — "Popular Occasions We Cover" (6 cards, 3-col desktop)

    Voice-search SEO: answers "what occasions are party buses good for?" and
    "can I rent a party bus for a concert in Chicago from New Lenox?"
    ─────────────────────────────────────────────────────────────────────────────
    Props
      id  string  Section id attribute. Defaults to 'party-bus-occasions'.
--}}
    ...
    <div class="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div class="max-w-3xl mb-12">
            <h2 style="font-family: var(--font-head); font-size: var(--font-size-h2); color: var(--navy); letter-spacing: var(--letter-spacing-h2); line-height: 1.2; font-weight: 700;" class="mb-5">
                One Bus for Every Type of Celebration
            </h2>
            <p style="font-family: var(--font-body); font-size: 1.2rem; color: var(--slate); line-height: 1.7;">
                Stop &amp; Go party bus limo buses are booked for all kinds of occasions across Chicagoland every weekend. Here is a look at the events we cover most often, and what makes each one a great fit for group transportation.
            </p>
        </div>
