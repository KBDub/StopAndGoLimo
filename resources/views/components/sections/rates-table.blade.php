<section id="rates-table" style="background: var(--cloud-light); scroll-margin-top: 80px;" class="py-12 lg:py-[6.25rem]">
    <div class="max-w-7xl mx-auto px-6">
        ...
        {{-- Pricing note --}}
        <p class="font-body" style="text-align: center; font-size: 0.875rem; color: var(--slate); margin: -1.5rem auto 2.5rem; max-width: 36rem;">
            All rates are flat-rate. Tax and tip are shown per ride. Prices shown as standard / peak rate where applicable.
        </p>
        ...
        <div class="mb-10">
            <x-ui.rates-vehicle-card
                ...
                imageAlt="Cadillac sedan — Stop and Go Airport Shuttle"
                tipLabel="Tip (20%)"
                :rows="[
        ...
        <div class="mb-10">
            <x-ui.rates-vehicle-card
                ...
                imageAlt="Black SUV Mercedes — Stop and Go Airport Shuttle"
                tipLabel="Tip (10% / 20%)"
                :rows="[
        ...
        {{-- STRETCH LIMOUSINE / LARGER GROUPS --}}
        <div class="mb-10">
            <x-ui.rates-vehicle-card
                name="Stretch Limousine"
                image="/images/sections/classy-limo.jpg"
                imageAlt="Stretch limousine for groups — Stop and Go Airport Shuttle"
                tipLabel="Tip (20%)"
                :rows="[
        ...
        <div class="mb-2">
            <x-ui.rates-vehicle-card
                ...
                imageAlt="Shuttle bus — Stop and Go Airport Shuttle"
                tipLabel="Tip (20%)"
                :rows="[
        ...
        {{-- Fine print --}}
        <p class="font-body" style="font-size: 0.75rem; color: var(--slate); text-align: center; margin-top: 2rem;">
            Rates are subject to change. Contact us for custom quotes on larger groups or extended trips.
        </p>
