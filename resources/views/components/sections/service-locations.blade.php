            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                @foreach($locations as $loc)
                    <div class="text-center">
                        ...
                        <div class="mx-auto mb-4" style="width: 2.5rem; height: auto;">
                            <svg aria-hidden="true" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg" style="fill: var(--champagne); width: 2rem; height: auto; margin: 0 auto;">
