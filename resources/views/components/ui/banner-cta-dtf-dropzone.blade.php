{{--
 | Repurposed: was DTF transfer upload banner — now a booking document dropzone banner.
 | Retains the same drop mechanics; the CustomEvent triggers the contact modal.
--}}

@props([
    'position'   => 'left',
    'heading'    => 'Upload Your Booking Document',
    'subheading' => 'Drop your file and we\'ll review it before confirming your reservation.',
        ...
        @endif
            ...
            <div class="flex-shrink-0 flex flex-col items-center gap-3 text-center">
                ...
                <p class="text-white/50 text-xs tracking-wide">
                    PNG &bull; JPG &bull; PDF only
                </p>
                <span class="text-xs text-white/40">Clear, high-quality files preferred</span>
            </div>
