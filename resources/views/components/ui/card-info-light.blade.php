...
<div {{ $attributes->merge(['class' => 'bg-warm-gradient p-6 rounded-xl shadow-lg border border-sunburst/30 hover:shadow-gold-lg transition-all hover:-translate-y-1']) }}>
