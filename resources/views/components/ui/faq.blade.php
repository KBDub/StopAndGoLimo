...
$questionStyle  = $isInvert
    ? 'background: var(--navy-light); color: var(--cloud-light);'
    : 'background: var(--navy); color: var(--cloud-light);';

$answerStyle    = $isInvert
    ? 'background: var(--navy-dark); color: var(--cloud); border-left: 3px solid var(--champagne);'
    : 'background: var(--cloud); color: var(--navy); border-left: 3px solid var(--champagne);';

$answerTextColor = $isInvert ? 'var(--cloud)' : 'var(--navy)';
@endphp
