    ...
    <header class="bg-charcoal text-white">
        <nav class="max-w-6xl mx-auto px-6 flex items-center justify-between py-4">
            ...
            <div class="hidden md:flex items-center space-x-6 text-sm font-semibold">
                <a href="/" class="text-white hover:text-sunburst transition-colors">Home</a>
        ...
        <div class="max-w-6xl mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-sm text-white/70">Premium Custom Signage & Apparel</span>
                </div>
            ...
            <div class="mt-8 pt-8 border-t border-slate text-center text-xs text-white/50">
