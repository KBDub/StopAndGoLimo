...
<script type="application/ld+json">
{
    ...
    "@@type": "LocalBusiness",
    "name": "Stop & Go Airport Shuttle Service, Inc. — Channahon, IL",
    "url": "{{ request()->url() }}",
    ...
    "description": "24/7 luxury limo and airport shuttle service in Channahon, IL. Airport transfers, weddings, corporate travel, and special events."
}
</script>
@endpush

<x-layouts.page
    title="Channahon Limo"
    metaDescription="24/7 limo and airport shuttle service in Channahon, IL. Transfers to O'Hare and Midway, corporate travel, weddings, and events."
...
>
    ...
    <x-sections.travel-in-style
        ...
        imageAlt="Happy clients in a limousine in Channahon, Illinois — Stop & Go Airport Shuttle Service, Inc."
        :inverted="true"
    />
    ...
    <x-sections.free-instant-quote
        ...
        descImageAlt="Premium interior of a limousine in Channahon, Illinois — Stop & Go Airport Shuttle Service, Inc."
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Comfortable transport experience in Channahon, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imagePosition="right"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Dynamic transportation in Channahon, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imagePosition="left"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="On-time arrival in Channahon, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
    />
