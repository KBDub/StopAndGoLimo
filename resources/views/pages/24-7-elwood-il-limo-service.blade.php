...
>
    <x-sections.category-hero
        ...
        subtitle="Will County private transportation, available day or night"
        subtitleIn="serving Elwood, Illinois"
        description="Stop & Go Airport Shuttle Service, Inc. provides 24-hour limousine and airport shuttle service throughout Elwood, Illinois. Situated in central Will County along Route 53, Elwood is home to the CenterPoint Intermodal Center, one of the largest inland ports in the country, and a growing community of residents and logistics professionals. We serve Elwood families and workers heading to O'Hare International Airport (ORD) and Midway International Airport (MDW) with flat-rate, door-to-door transfers and real-time flight monitoring. No matter what time your flight departs or arrives, we are ready. Beyond airport transportation, we serve Elwood residents with limousine and group transportation for weddings, birthday celebrations, bachelorette parties, quinceañera events, corporate travel, and special occasions of every kind. Our chauffeurs are background-checked, uniformed, and experienced throughout Will County and all of Chicagoland. We also serve Joliet, Manhattan, Wilmington, and all surrounding communities. Our pricing is flat-rate and clearly quoted before you book. Book online or call us any time."
