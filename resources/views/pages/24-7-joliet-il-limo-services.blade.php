...
<script type="application/ld+json">
{
    ...
    "@@type": "LocalBusiness",
    "name": "Stop & Go Airport Shuttle Service, Inc. — Joliet, IL",
    "url": "{{ request()->url() }}",
    "telephone": "",
    "address": {
        "@@type": "PostalAddress",
    ...
    "description": "24/7 luxury limo and airport shuttle service in Joliet, IL. Airport transfers, weddings, corporate travel, and special events."
}
</script>
@endpush
...
<x-layouts.page
    title="Joliet Limo"
    metaDescription="24/7 limo and airport shuttle service in Joliet, IL. Transfers to O'Hare and Midway, corporate travel, weddings, and events."
...
>
    ...
    <x-sections.travel-in-style
        ...
        headingBold="Covered"
        body="Stop & Go Airport Shuttle Service, Inc. offers dependable transportation services throughout Joliet. We provide a professional 24/7 Joliet airport shuttle to O'Hare and Midway, limousine service for weddings and special events, and party bus rentals for group celebrations — all backed by experienced chauffeurs and a commitment to on-time service."
        image="/images/sections/joliet-limo.jpg"
        imageAlt="Rialto Square Theatre in Joliet, Illinois — Stop & Go Airport Shuttle Service, Inc."
        :inverted="true"
    />
    ...
    <x-sections.info-strip
        ...
        body="Stop & Go Airport Shuttle Service, Inc. offers 24/7 Joliet airport shuttle service, limousine service for weddings and events, and party bus rentals for celebrations. Serving all Joliet neighborhoods, our professional chauffeurs provide reliable, comfortable transportation to O'Hare, Midway, and throughout the Chicago area."
    />
    ...
    <x-sections.free-instant-quote
        ...
        descBody="As Joliet's trusted transportation provider for over 15 years, Stop & Go Airport Shuttle Service, Inc. offers complete luxury transportation services:"
        ...
        descImageAlt="Wedding and event transportation in Joliet, Illinois — Stop & Go Airport Shuttle Service, Inc."
    />
    ...
    <x-sections.travel-in-style
        ...
        imageAlt="Chicago O'Hare International Airport tower — Stop & Go Airport Shuttle Service, Inc. serving Joliet"
        imagePosition="right"
        :inverted="true"
    />
