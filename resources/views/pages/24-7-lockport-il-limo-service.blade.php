...
>
    <x-sections.category-hero
        ...
        subtitle="Historic Lockport, IL, served by a modern professional fleet"
        subtitleIn="serving Lockport, Illinois"
        description="Stop & Go Airport Shuttle Service, Inc. provides 24-hour limousine and airport shuttle service throughout Lockport, Illinois. One of Will County's oldest and most charming communities, Lockport is home to Lock 1 of the historic Illinois and Michigan Canal, excellent dining along Division Street, and a thriving residential community growing rapidly with new neighborhoods and families. We serve Lockport residents heading to O'Hare International Airport (ORD) and Midway International Airport (MDW) with flat-rate, door-to-door transfers and real-time flight tracking. Early morning, late night, or anything in between, we are ready. We also serve Lockport with premium event transportation: wedding limousines for couples at local venues and area event spaces, party buses for prom groups from Lockport Township High School, birthday and bachelorette celebrations, quinceañera transportation, and corporate car service along the I-355 corridor. Every chauffeur is background-checked, uniformed, and professionally trained. We serve Joliet, Homer Glen, Romeoville, Plainfield, and all surrounding Will County communities. Flat-rate pricing, no surprises. Book online or call us any time."
