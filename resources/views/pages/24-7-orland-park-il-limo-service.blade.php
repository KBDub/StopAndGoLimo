...
<script type="application/ld+json">
{
    ...
    "@@type": "LocalBusiness",
    "name": "Stop & Go Airport Shuttle Service, Inc. — Orland Park, IL",
    "url": "{{ request()->url() }}",
    ...
    "description": "24/7 luxury limo and airport shuttle service in Orland Park, IL. Airport transfers, weddings, corporate travel, and special events."
}
</script>
@endpush
...
<x-layouts.page
    ...
    metaDescription="24/7 limo and airport shuttle service in Orland Park, IL. Transfers to O'Hare and Midway, corporate travel, weddings, and events."
...
>
    <x-sections.category-hero
        ...
        image="/images/sections/orland-park-hero-new.jpg"
    ...
    <x-sections.travel-in-style
        ...
        imageAlt="Comfortable limousine service in Orland Park, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imagePosition="left"
        :inverted="true"
    />
    ...
    <x-sections.free-instant-quote
        ...
        descImageAlt="Orland Park limousine transportation — Stop & Go Airport Shuttle Service, Inc."
        :descImageTop="true"
        :inverted="true"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Travel with confidence in Orland Park, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imagePosition="right"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Flexible transportation options in Orland Park, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imagePosition="left"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Creating elegant arrivals in Orland Park, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
    />
    ...
    <x-sections.faq preset="orland-park" />
