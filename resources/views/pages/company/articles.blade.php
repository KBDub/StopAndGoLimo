<x-layouts.page
    ...
    metaDescription="Helpful articles, tips, and design advice from Top 5 Percent, your veteran-owned custom signage and apparel shop in Joliet, Will and DuPage County and the greater Chicagoland area."
    currentPage="about">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="block bg-linen">
                    <div class="overflow-hidden">
                        <img src="/images/stickers-decals/top5pct-article-buy-stickers-decals-joliet.jpg" alt="Where to buy custom stickers in Joliet Illinois" class="w-full h-48 object-cover" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <div class="block bg-linen">
                    <div class="overflow-hidden">
                        <img src="/images/window-wall-floor-decals/top5pct-article-window-wall-signs.jpg" alt="Window and wall sign tips for businesses in Joliet Illinois" class="w-full h-48 object-cover" loading="lazy" />
                    </div>
                    <div class="p-6">
