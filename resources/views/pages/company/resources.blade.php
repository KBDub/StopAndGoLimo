    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-charcoal font-bold text-h2 mb-3">Tips, Guides & Articles</h2>
                <div class="h-1 w-24 bg-sunburst mx-auto mb-6"></div>
                <p class="text-charcoal-light text-body max-w-3xl mx-auto">We have been in the custom print business since 2017. Along the way we have learned a lot about what helps our customers get the best results. Here are some of the most helpful topics we cover with customers regularly.</p>
            </div>

            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <a href="/blog/custom-t-shirt-tips" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/top5pct-t-shirt-maker-7-tips.jpg" alt="7 tips for ordering custom t-shirts from Top 5 Percent in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/window-wall-signs" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-charcoal-light text-body-sm">How to turn your storefront glass and interior walls into powerful advertising space using vinyl decals, graphics, and murals.</p>
                    </div>
                </a>
                <a href="/blog/car-wraps-vinyl-lettering" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/automobile-graphics/top5pct-article-car-wraps-vinyl-lettering.jpg" alt="Car wraps and vinyl lettering for vehicles in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                        <h3 class="text-h3 font-bold text-charcoal mb-2">Car Wraps vs. Vinyl Lettering</h3>
                        <p class="text-charcoal-light text-body-sm">What is the difference, which one is right for your vehicle, and what to expect from the installation process.</p>
                    </div>
                </a>
                <a href="/blog/corporate-wear-guide" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/corporate-wear/toptpct-article-corporate-wear-pic1.jpg" alt="Corporate wear and branded uniforms for businesses in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
                ...
                <a href="/blog/spirit-wear-tips" class="group block bg-linen hover:bg-linen-dark transition-colors">
                    <div class="overflow-hidden">
                        <img src="/images/spirit-wear/top5pct-article-spirit-wear-pic1.jpg" alt="Spirit wear and fan apparel for schools and sports teams in Joliet Illinois" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                    </div>
                    <div class="p-6">
