...
<x-layouts.page
    title="Dye Sublimation Shirts Joliet IL | All Over Print Custom Apparel | Top 5 Percent"
    ...
    >
        ...
        <p>We work with polyester and polyester-blend fabrics that accept dye sublimation inks most effectively. The process requires a light or white base fabric for the colors to appear true, so it is best suited for white or light-colored garments. Call us at (815) 349 8600 to discuss your project and let us show you samples of our dye sublimation work.</p>
    </x-sections.card-image-with-text>
    ...
    <x-sections.faq
        ...
        :faqs="[
            ['q' => 'What is dye sublimation printing?', 'a' => 'Dye sublimation uses heat and pressure to bond ink directly into polyester fibers, producing a permanent, all-over full-color print that will never crack, peel, or fade. The color becomes part of the fabric itself.'],
