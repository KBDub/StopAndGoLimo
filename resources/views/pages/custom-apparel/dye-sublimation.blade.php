...
<x-layouts.page
    ...
    >
        ...
        <p class="mb-4">This makes dye sublimation the ideal choice for performance jerseys, athletic wear, cycling apparel, and <a href="/custom-apparel/group-wear/spirit-wear-shirts" class="link-notification">spirit wear</a> where you want a bold, edge-to-edge visual impact. Sports teams across Joliet, Shorewood, and Will and DuPage County use our dye sublimation printing for jerseys and uniforms that look sharp on the field and hold up through hundreds of washes without losing their brightness or definition.</p>
        <p>At <a href="/" class="link-notification">Top 5 Percent</a>, we work with polyester and polyester-blend fabrics that accept dye sublimation inks most effectively. The process requires a light or white base fabric for the colors to appear true, so it is best suited for white or light-colored garments. For cotton fabrics or mixed-fabric orders, <a href="/custom-apparel/printing-options/dtf-printing" class="link-notification">DTF transfers</a> are a great alternative that handles any fabric type. Call us at <a href="tel:+18153498600" class="link-notification">(815) 349-8600</a> to discuss your project.</p>
    </x-sections.card-image-with-text>
    ...
    $pageFaqs = [
        ...
        ['q' => 'How long does a dye sublimation order take in Joliet?', 'a' => 'Most sublimation orders are completed within one to three business days. Call <a href="tel:+18153498600" class="link-notification">(815) 349-8600</a> to confirm lead time for your quantity and design.'],
    ];
    @endphp
    <x-sections.faq
