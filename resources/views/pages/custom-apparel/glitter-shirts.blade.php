...
<x-layouts.page
    ...
    >
        ...
        <p>We review every glitter shirt design before production to confirm it will translate correctly to the vinyl format. Glitter vinyl works best with bold, clean shapes and text — the same design guidelines that apply to standard vinyl. For even more dimension, <a href="/custom-apparel/printing-options/rhinestone-apparel" class="link-notification">rhinestone shirts</a> combine crystal elements with glitter vinyl for a layered sparkle effect. We also carry <a href="/custom-apparel/specialty-materials/holographic-shirts" class="link-notification">holographic</a> vinyl in shifting rainbow finishes as an alternative. Call us at (815) 349 8600 to discuss your glitter shirt project today.</p>
    </x-sections.card-image-with-text>
    ...
    <x-sections.card-image-with-text
        ...
        imagePosition="right"
    >
        <p class="mb-4">No occasion celebrates itself quite as well as one where the attendees are wearing matching glitter shirts. For <a href="/custom-apparel/group-wear/reunion-shirts" class="link-notification">bachelorette parties</a>, we produce glitter shirts with "Bride," "Bridesmaid," "Maid of Honor," and custom names in bold glitter lettering that makes the whole group look coordinated and celebratory the moment they walk in the door. For birthday events, a glitter shirt with the guest of honor's name and milestone age creates a keepsake that captures the spirit of the occasion long after the party ends.</p>
    ...
    >
        ...
        <x-slot name="mid">
            ...
            <p class="mb-4">We work with glitter vinyl in gold, silver, rose gold, red, royal blue, emerald green, black glitter, holographic multi-color, and other specialty glitter finishes. This palette gives you the flexibility to match your glitter shirt to your event's color theme precisely — gold for a fiftieth anniversary, rose gold for a bridal event, silver for a New Year's celebration, or school colors for a spirit event. We can also combine multiple glitter colors in a single design if your concept calls for it. For a solid metallic look without glitter particles, see our <a href="/custom-apparel/specialty-materials/foil-shirts" class="link-notification">foil shirts</a> in gold and silver.</p>
        </x-slot>
        <x-slot name="lower">
        ...
        <x-slot name="footer">
            <p class="mb-4">We are a veteran owned <a href="/custom-apparel" class="link-notification">custom apparel shop</a> at 121 Springfield Avenue in Joliet, Illinois. We produce glitter shirts and specialty celebration apparel for individuals, groups, and organizations throughout Will County and the Chicagoland area with no minimum orders and fast turnaround.</p>
