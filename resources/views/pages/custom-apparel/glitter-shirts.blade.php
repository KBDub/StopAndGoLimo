...
<x-layouts.page
    ...
    >
        ...
        <p>We review every glitter shirt design before production to confirm it will translate correctly to the vinyl format. Glitter vinyl works best with bold, clean shapes and text — the same design guidelines that apply to standard vinyl. For even more dimension, <a href="/custom-apparel/printing-options/rhinestone-apparel" class="link-notification">rhinestone shirts</a> combine crystal elements with glitter vinyl for a layered sparkle effect. We also carry <a href="/custom-apparel/holographic-shirts" class="link-notification">holographic</a> vinyl in shifting rainbow finishes as an alternative. Call us at (815) 349 8600 to discuss your glitter shirt project today.</p>
    </x-sections.card-image-with-text>
