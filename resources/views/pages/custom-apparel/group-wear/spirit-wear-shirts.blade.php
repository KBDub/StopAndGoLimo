...
<x-layouts.page title="Spirit Wear" metaDescription="Custom spirit wear for schools, teams, and organizations in Joliet IL. T-shirts, hoodies, rhinestone, glow in the dark, and fan wear. Veteran owned, serving" currentPage="custom-apparel">
    ...
    <x-sections.cta-quadruple-button-banner />
        ...
        >
            ...
            <p class="mb-4">We print on t shirts, hoodies, long sleeve shirts, crewnecks, and more. We offer <a href="/custom-apparel/printing-options/dtf-printing" class="link-notification">DTF transfers</a>, <a href="/custom-apparel/printing-options/screen-printing" class="link-notification">screen printing</a>, vinyl heat transfers, <a href="/custom-apparel/printing-options/rhinestone-apparel" class="link-notification">rhinestone decoration</a>, <a href="/custom-apparel/specialty-materials/glitter-shirts" class="link-notification">glitter designs</a>, and <a href="/custom-apparel/glow-in-the-dark-shirts" class="link-notification">glow in the dark</a> options. No matter what your school colors are or what style your students prefer, we can create spirit wear that your whole school will love to wear to the next big game. We work with schools of all sizes and we are ready to handle large group orders with ease.</p>
