...
<x-layouts.page
    ...
    <x-sections.card-image-with-text
        ...
        imagePosition="right"
    >
        <p class="mb-4">Embroidery is the preferred decoration method for <a href="/custom-apparel/group-wear/corporate-wear-shirts" class="link-notification">corporate uniforms</a>, employee workwear, and <a href="/design-services/logo-design" class="link-notification">professionally branded apparel</a> because it creates a finished, polished look that is appropriate for client-facing environments. An embroidered polo with a precisely rendered company logo is the standard for businesses that want their team to look credible and professional in front of customers. Construction firms, medical practices, real estate teams, and service companies throughout Will County use embroidered apparel as a core component of their professional image.</p>
    ...
    >
        ...
        <x-slot name="lower">
            ...
            <p class="mb-4">Embroidery requires a digitized design file — a DST or similar format — that tells the embroidery machine exactly how to stitch the design. If you do not have a digitized version of your logo, we handle the digitization process in-house. Our <a href="/design-services/logo-design" class="link-notification">logo design</a> team can also help if you need artwork built from scratch. We prepare your logo for embroidery production in a way that maintains its integrity at the stitching scale and ensures crisp, accurate reproduction on the finished garment. We keep your digitized file on record for future orders so you never have to go through setup again.</p>
        </x-slot>
        <x-slot name="footer">
            <p class="mb-4">We are a veteran owned custom apparel shop at 121 Springfield Avenue in Joliet, Illinois. We produce professional embroidered apparel for businesses, organizations, sports teams, and individuals throughout Will County and the greater Chicagoland area. For bold graphic designs on apparel, see our <a href="/custom-apparel/printing-options/screen-printing" class="link-notification">screen printing</a> or <a href="/custom-apparel/printing-options/dtf-printing" class="link-notification">DTF transfers</a> options as well. Embroidered options are also available for <a href="/custom-apparel/group-wear/reunion-shirts" class="link-notification">reunion shirts</a> and <a href="/custom-apparel/group-wear/spirit-wear-shirts" class="link-notification">spirit wear</a> orders.</p>
