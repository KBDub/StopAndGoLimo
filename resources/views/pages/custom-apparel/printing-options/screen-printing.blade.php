...
<x-layouts.page
    ...
    >
        <p class="mb-4">Screen printing is the most time-tested and widely used method for decorating custom apparel, and for good reason. The process pushes thick, opaque ink directly through a mesh screen onto the fabric, building up a solid color layer that sits on the surface with a tactile presence you can feel with your fingertip. The result is a bold, high-contrast print that looks professional and holds up through years of washing without fading, cracking, or peeling under normal wear conditions. For straightforward designs with one to six colors and quantities of twelve or more, screen printing is typically the most cost-effective production method available.</p>
        <p class="mb-4">Screen printing works on virtually any fabric type, including cotton, polyester, blends, and performance fabrics. It is the standard method for <a href="/custom-apparel/group-wear/spirit-wear-shirts" class="link-notification">event shirts</a>, <a href="/custom-apparel/group-wear/corporate-wear-shirts" class="link-notification">company uniforms</a>, team apparel, band merchandise, and organization gear across Joliet and throughout Will County. When you need matching shirts for a large group and you want them to look consistent, clean, and durable, screen printing is the right call.</p>
        <p>We produce screen printed apparel for businesses, schools, churches, sports teams, and community organizations throughout the Chicagoland area. For full-color photographic designs or small runs without setup fees, see our <a href="/custom-apparel/printing-options/dtf-printing" class="link-notification">DTF transfers</a>. Call us at (815) 349-8600 or visit 121 Springfield Avenue in Joliet to talk about your screen printing project today.</p>
    </x-sections.card-image-with-text>
    ...
    >
        ...
        <x-slot name="mid">
            ...
            <p class="mb-4">Plastisol screen printing inks are cured with heat during production, creating a bond with the fabric that holds up through years of washing and regular use. A properly screen-printed shirt will maintain its graphic through dozens or even hundreds of washes without significant fading, cracking, or peeling. This durability makes screen printing ideal for uniforms, team gear, and any apparel that will be worn and washed frequently. For maximum durability in professional settings, <a href="/custom-apparel/printing-options/embroidery" class="link-notification">embroidery</a> stitches your logo directly into the fabric.</p>
            <h3 class="text-h3 font-bold text-charcoal mb-2">3. Best Cost Per Unit for Larger Quantities</h3>
            <p class="mb-4">While screen printing has setup costs — one screen per color in the design — those costs are spread across the full order quantity. The more shirts you order, the lower the cost per unit. For orders of twenty-four or more shirts, screen printing is consistently the most cost-effective decorating method available, especially for designs with one to four colors.</p>
        </x-slot>
        <x-slot name="lower">
