...
<x-layouts.page
    ...
    >
        ...
        <p class="mb-4">Screen printing works on virtually any fabric type, including cotton, polyester, blends, and performance fabrics. It is the standard method for event shirts, company uniforms, team apparel, band merchandise, and organization gear across Joliet and throughout Will County. When you need matching shirts for a large group and you want them to look consistent, clean, and durable, screen printing is the right call.</p>
        <p>We produce screen printed apparel for businesses, schools, churches, sports teams, and community organizations throughout the Chicagoland area. Call us at (815) 349 8600 or visit 121 Springfield Avenue in Joliet to talk about your screen printing project today.</p>
    </x-sections.card-image-with-text>
    ...
    >
        ...
        <x-slot name="lower">
            ...
            <p class="mb-4">Screen printing works on cotton, cotton blends, polyester, and most other common apparel materials. T-shirts, hoodies, sweatshirts, polos, tote bags, and hats are all fair game. The versatility of screen printing across garment types makes it the logical choice when you need a consistent look across a mixed apparel order.</p>
        </x-slot>
        <x-slot name="footer">
            <p class="mb-4">We are a veteran owned print shop in Joliet, Illinois serving businesses, sports teams, schools, and organizations throughout Will County. We handle everything from artwork preparation through production and delivery in-house so your order comes out exactly right.</p>
