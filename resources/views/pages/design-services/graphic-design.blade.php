...
<x-layouts.page
    ...
    >
        <p class="mb-4">Good graphic design is the bridge between your idea and a finished print product that looks exactly the way you imagined it. Our design team prepares layouts for signs, banners, apparel, promotional products, and any other print application with production quality built in from the start. We understand the technical requirements of every product we produce — correct bleed settings, color profiles, resolution requirements, and material-specific design constraints — so your files never get stuck at prepress and your finished products look sharp and accurate every time.</p>
        <p class="mb-4">We work with customers who have an existing concept they need laid out professionally, customers who have rough sketch ideas they want turned into polished artwork, and customers who need us to create something from scratch based on a conversation about their brand and goals. No matter where you are starting from, we can take you from concept to print-ready file efficiently and without the back-and-forth that comes from working with a designer who does not understand print production.</p>
    ...
    <x-sections.card-image-with-text
        ...
        imagePosition="right"
    >
        <p class="mb-4">Our graphic design services cover every product we produce. We can design custom shirt graphics, banner and sign layouts, sticker and decal artwork, promotional product designs, trade show display graphics, event programs, and anything else you need to look great in print. We use industry-standard design software and deliver files in every format required for production — whether that means vector files for vinyl cutting, high-resolution rasters for large-format printing, or embroidery-ready DST files for machine stitching.</p>
    ...
    >
        ...
        <x-slot name="lower">
            ...
            <p class="mb-4">Many of our clients return to us repeatedly for new design work because having a single trusted design and production partner simplifies their entire marketing material workflow. We maintain your brand files, understand your design standards, and can produce new variations quickly without starting from scratch every time. For businesses that regularly need new event shirts, updated banner designs, or seasonal promotional materials, this ongoing relationship saves significant time and ensures consistent quality across everything your brand produces.</p>
        </x-slot>
        <x-slot name="footer">
            <p class="mb-4">We are a veteran owned design and print shop at 121 Springfield Avenue in Joliet, Illinois. We serve businesses, organizations, and individuals throughout Will County and the Chicagoland area with professional graphic design services that produce results in print, not just on screen.</p>
            <p>Call us at (815) 349 8600 to discuss your graphic design project today — layout, concept development, artwork correction, and print-ready file delivery all available.</p>
        </x-slot>
    </x-sections.card-detailed-info>
