    ...
    <section id="our-fleet" style="background: var(--navy); scroll-margin-top: 80px;" class="py-16">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div style="margin-bottom: 2.5rem;">
                ...
                <div style="height: 3px; background: var(--champagne); width: 4rem; margin-top: 0.75rem; margin-bottom: 1.25rem;"></div>
                <p class="font-body" style="font-size: 1.125rem; color: var(--cloud); line-height: 1.7; max-width: 62ch;">
