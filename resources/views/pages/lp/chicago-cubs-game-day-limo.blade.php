<x-layouts.lp
    title="Premium Chicago Cubs Limo Service & Wrigleyville Party Bus Rentals"
    metaDescription="Zero parking stress at Wrigley Field. Stop & Go Airport Shuttle Service, Inc. delivers your group to Clark and Addison in a luxury party bus or stretch limo. Flat-rate pricing. Book your Cubs game day ride today."
    ogImage="/images/special-events/cubs/stopngolimo-chicacgo-cubs-wrigley-field.jpg"
    ogImageAlt="Wrigley Field on a Chicago Cubs game day, served by Stop & Go Airport Shuttle Service, Inc."
>

    {{-- ─── Hero ─────────────────────────────────────────────────────────────── --}}
    <section id="lp-hero"
             style="position: relative; min-height: 82vh; display: flex; align-items: center; justify-content: center;
                    background-image: url('/images/special-events/cubs/stopngolimo-chicacgo-cubs-wrigley-field.jpg');
        ...
        <div style="position: relative; z-index: 1; max-width: 860px; margin: 0 auto; padding: 4rem 1.5rem; text-align: center;">
            <h1 class="font-head"
                ...
                Premium Chicago Cubs Limo Service
                <strong style="display: block; color: var(--champagne); font-weight: 700;">
                    &amp; Wrigleyville Party Bus Rentals
                </strong>
            </h1>
            <p class="font-body"
               style="font-size: clamp(1rem, 2.5vw, 1.2rem); color: var(--cloud); line-height: 1.7; margin-bottom: 2.25rem; max-width: 700px; margin-left: auto; margin-right: auto;">
                We drive your group to Clark and Addison in total luxury. Zero parking stress. No surge rates.
                24/7 chauffeured service for all of Chicagoland, from Wrigleyville drop-off to your front door.
            </p>
        ...
        <div style="max-width: 1100px; margin: 0 auto;">
            ...
            <p class="font-body"
               style="color: var(--slate); font-size: 1rem; line-height: 1.75; text-align: center; max-width: 640px; margin: 0 auto 2.75rem;">
                From your driveway to the Wrigley gates, every detail is handled. Here is what your group gets on every ride.
            </p>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
                <div style="border-left: 4px solid var(--champagne); background: var(--navy); padding: 2rem 1.5rem;">
                    <h3 class="font-head"
                        ...
                        Zero Parking Worries
                    </h3>
                    <p class="font-body"
                       style="color: var(--cloud); font-size: 0.95rem; line-height: 1.7; margin: 0;">
                        We drop your crew off right at the Wrigley Field entry gates. No circling Wrigleyville. No meter running. No $50 lot fees. Our chauffeur handles all of it while you walk straight to the turnstiles.
                    </p>
                </div>
                <div style="border-left: 4px solid var(--champagne); background: var(--navy); padding: 2rem 1.5rem;">
                    <h3 class="font-head"
                        style="color: var(--champagne); font-size: 1.15rem; font-weight: 700; margin-bottom: 0.75rem; line-height: 1.35;">
                        High-End Party Buses
                    </h3>
                    <p class="font-body"
                       style="color: var(--cloud); font-size: 0.95rem; line-height: 1.7; margin: 0;">
                        Built-in ice chests, LED lighting, and Bluetooth audio come standard. Your group controls the music, the temperature, and the vibe from the moment you step on board in the suburbs to the moment you arrive at Clark and Addison.
                    </p>
                </div>
                <div style="border-left: 4px solid var(--champagne); background: var(--navy); padding: 2rem 1.5rem;">
                    <h3 class="font-head"
                    ...
                    <p class="font-body"
                       style="color: var(--cloud); font-size: 0.95rem; line-height: 1.7; margin: 0;">
                        We never charge surge fees after extra-inning games. Your rate is locked at booking. Rain delay, bonus innings, or a post-game Wrigleyville stop, the price stays exactly what we quoted you.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div style="max-width: 720px; margin: 0 auto;">
            <div style="width: fit-content; margin: 0 auto 1.5rem;">
                <h2 class="font-head"
                    ...
                    Ready to Book Your
                    <strong style="font-weight: 700; color: var(--champagne);">Cubs Game Day Ride?</strong>
                </h2>
                <div style="height: 3px; background: var(--champagne); width: 116%; max-width: calc(100vw - 3rem); margin-top: 0.85rem;"></div>
            </div>
            <p class="font-body"
        ...
        <div style="max-width: 1100px; margin: 0 auto;">
            ...
            <p class="font-body"
               style="color: var(--slate); font-size: 1rem; line-height: 1.75; margin-bottom: 2.75rem; max-width: 700px;">
                Game day rides are just the beginning. Stop &amp; Go Airport Shuttle Service, Inc. handles every occasion that calls for a professional chauffeur and a premium vehicle.
            </p>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(290px, 1fr)); gap: 1.5rem;">
                ...
                <div style="border: 1px solid var(--cloud); border-top: 4px solid var(--champagne); padding: 2rem 1.5rem; display: flex; flex-direction: column;">
                    <h3 class="font-head"
                        ...
                        Cubs Game Bachelor &amp; Bachelorette Parties
                    </h3>
                    <p class="font-body"
                       style="color: var(--slate); font-size: 0.95rem; line-height: 1.7; flex: 1; margin-bottom: 1.25rem;">
                        We turn Cubs game day into an unforgettable group outing. Party buses with built-in coolers and Bluetooth audio, plus multi-address pickup from anywhere in Chicagoland. Call us and we will build the full game day itinerary around your party.
                    </p>
                    <button onclick="window.dispatchEvent(new Event('open-modal-quote'))"
                            class="font-head"
                ...
                <div style="border: 1px solid var(--cloud); border-top: 4px solid var(--champagne); padding: 2rem 1.5rem; display: flex; flex-direction: column;">
                    <h3 class="font-head"
                        style="color: var(--navy); font-size: 1.1rem; font-weight: 700; margin-bottom: 0.75rem; line-height: 1.4;">
                        Corporate Suite &amp; Gallagher Way VIP Hospitality
                    </h3>
                    <p class="font-body"
                       style="color: var(--slate); font-size: 0.95rem; line-height: 1.7; flex: 1; margin-bottom: 1.25rem;">
                        Impress clients or reward your team at Wrigley. We handle executive transfers, multi-address pickups, and coordination with your suite host. Our chauffeurs arrive early and wait until the last guest is ready to depart.
                    </p>
                    <button onclick="window.dispatchEvent(new Event('open-modal-quote'))"
                            class="font-head"
                            style="background: var(--navy); color: var(--champagne); border: none; padding: 0.65rem 1.25rem; font-size: 0.875rem; font-weight: 700; cursor: pointer; align-self: flex-start;">
                ...
                <div style="border: 1px solid var(--cloud); border-top: 4px solid var(--champagne); padding: 2rem 1.5rem; display: flex; flex-direction: column;">
                    <h3 class="font-head"
                        style="color: var(--navy); font-size: 1.1rem; font-weight: 700; margin-bottom: 0.75rem; line-height: 1.4;">
                        Lakefront Wedding Photography Shuttles
                    </h3>
                    <p class="font-body"
                       style="color: var(--slate); font-size: 0.95rem; line-height: 1.7; flex: 1; margin-bottom: 1.25rem;">
                        After the ceremony, let us take the wedding party along Lake Shore Drive for photos before the reception. We know every lakefront pull-off and park entrance and will build a custom photo route around your photographer's timeline.
                    </p>
                    <button onclick="window.dispatchEvent(new Event('open-modal-quote'))"
                            class="font-head"
                            style="background: var(--navy); color: var(--champagne); border: none; padding: 0.65rem 1.25rem; font-size: 0.875rem; font-weight: 700; cursor: pointer; align-self: flex-start;">
    ...
    <section id="lp-cta-bottom"
        ...
        <div style="max-width: 700px; margin: 0 auto;">
            <h2 class="font-head"
                ...
                Your Wrigley Field Group Ride Is One Call Away
            </h2>
            <p class="font-body"
