...
<script type="application/ld+json">
{
    ...
    "@@type": "LocalBusiness",
    "name": "Stop & Go Airport Shuttle Service, Inc. — Morris, IL",
    "url": "{{ request()->url() }}",
    "telephone": "",
    "address": {
        "@@type": "PostalAddress",
    ...
    "description": "24/7 luxury limo and airport shuttle service in Morris, IL. Airport transfers, weddings, corporate travel, and special events."
}
</script>
@endpush

<x-layouts.page
    title="Morris IL Limo"
    metaDescription="24/7 limo and airport shuttle service in Morris, IL. Transfers to O'Hare and Midway, corporate travel, weddings, and events."
...
>
    ...
    <x-sections.travel-in-style
        ...
        imageAlt="White limousine in Morris, Illinois — Stop & Go Airport Shuttle Service, Inc."
        :inverted="true"
    />
    ...
    <x-sections.free-instant-quote
        ...
        imageAlt="Morris Municipal Airport, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imageObjectPosition="center"
        rightVariant="description"
        descHeading="Why Choose Us?"
        descSubheading="Complete Transportation Solutions for Morris Residents"
        descBody="As Morris's trusted transportation provider for over 15 years, Stop & Go Airport Shuttle Service, Inc. offers complete luxury transportation services:"
        :descBullets="[
        ...
        descImageAlt="Morris Municipal Airport, Illinois — Stop & Go Airport Shuttle Service, Inc."
        :descImageTop="true"
    />
    ...
    <x-sections.travel-in-style
        ...
        imageAlt="Morris Illinois Family Center — Stop & Go Airport Shuttle Service, Inc."
        imagePosition="right"
        :inverted="true"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Comfortable and stylish travel in Morris, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imagePosition="right"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Personalized transportation in Morris, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
        imagePosition="left"
    />
    ...
    <x-sections.image-info-card
        ...
        imageAlt="Elegant transportation for special occasions in Morris, Illinois — Stop & Go Airport Shuttle Service, Inc."
        imageAspect="16/9"
    />
