...
<script type="application/ld+json">
{
    ...
    "description": "24/7 luxury limo and airport shuttle service in Plainfield, IL. Airport transfers, weddings, corporate travel, and special events."
}
</script>
@endpush
...
<x-layouts.page
    ...
    metaDescription="24/7 limo and airport shuttle service in Plainfield, IL. Transfers to O'Hare and Midway, corporate travel, weddings, and events."
...
>
    ...
    <x-sections.faq preset="plainfield" />
