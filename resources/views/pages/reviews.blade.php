@php
$reviews = [
    ['name' => 'Brittany H.',      'quote' => 'They did an outstanding job on my custom shirts. I shared my concept and it was brought to life with precision and creativity. Excellent quality, great communication, and fast turnaround. I highly recommend!'],
    ...
    ['name' => 'Renea F.',          'quote' => 'My husband and I went to Top 5 Percent and were able to speak with the owner about the different services offered. He was so very nice and patient. He took the time to explain things to us regarding different fabrics, options, and pricing. Excellent customer service! We will definitely be back.'],
    ['name' => 'Lori S.',           'quote' => 'Top 5 Percent made custom koozies for a party in less than a week and they turned out perfect. Would definitely recommend them!'],
    ['name' => 'Tracy M.',          'quote' => 'I had koozies made for my good friend\'s business as a gift for her grand opening. Ezra had them ready the date I needed them and they looked GREAT! She was very happy with them. I recommend Top 5% 100%! Thanks Ezra!'],
    ['name' => 'Lucia I.',          'quote' => 'Really nice service. The result of my customized coffee mugs were really good. I had a nice experience with them. I really recommend this place!'],
    ['name' => 'Mykel A.',          'quote' => 'I had an idea, Ezra made it a reality. I will be using again. Top notch service.'],
    ['name' => 'Gerardo Z.',        'quote' => 'Good customer service and you met my expectations! Keep up the good work and I\'ll definitely be sending people your way.'],
    ['name' => 'Jonathan Y.',       'quote' => 'Amazing service and quality! Will definitely be doing more business in the future.'],
    ['name' => 'Ania J.',           'quote' => 'Beautiful stitching! We are very happy with the results! Thank you!'],
    ['name' => 'Anita E.',          'quote' => 'Professional business man. I am so pleased with the banner and signs he made for my church and I will definitely continue to support his business.'],
    ['name' => 'Arleen V.',         'quote' => 'Great service, good customer service, excellent work. Very satisfied.'],
    ['name' => 'Arthur J.',         'quote' => 'Great service!'],
    ['name' => 'Brenda S.',         'quote' => 'Great business to support! We went there to get fingerprinted for conceal carry license and the process was simple and quick. They offer a lot of different services. This business is veteran owned and operated so please help support them!'],
    ['name' => 'Brian B.',          'quote' => 'Ezra was fantastic! He threw a shirt together with extremely short notice that was beyond expectations. I highly recommend Top 5 Percent.'],
    ['name' => 'Carlos H.',         'quote' => 'Able to get our plans of a Christmas gift done before Christmas. Low price also.'],
    ['name' => 'Chewy O.',          'quote' => 'Outstanding and excellent service. The quality of the decals are flawless. I will definitely be doing more business in the future.'],
    ['name' => 'Chrissy R.',        'quote' => 'This place is awesome!! Great customer service and my shirts were exactly what I wanted. I will definitely be back again.'],
    ['name' => 'Christian A.',      'quote' => 'They are the best people to do business with. Believe me.'],
    ['name' => 'Christina M.',      'quote' => 'I absolutely love the quality of their work but more importantly the communication was the greatest experience. Thank you!!'],
    ['name' => 'Colin M.',          'quote' => 'Great service, quality, and help. I thought it was a little pricey at first but for the kind of help you get it is definitely worth it.'],
    ['name' => 'Datjaeda',          'quote' => 'Needed a banner for my Annual Event. Ezra\'s team delivered again! Fantastic work, great price, great quality!'],
    ['name' => 'David R.',          'quote' => 'Thank you for helping with a gift to a friend! Looks great! Highly recommended!'],
    ['name' => 'Deborah P.',        'quote' => 'I am always satisfied with my merchandise. Excellent customer service.'],
    ['name' => 'Diamond U.',        'quote' => 'Got a shirt made super last minute and they were still able to accommodate me. Always great service every time I come in!'],
    ['name' => 'DN Electric',       'quote' => 'What a great experience working with Ezra. He was so helpful in figuring out a decal for our business. We will definitely be back if we need anything.'],
    ...
    ['name' => 'Lih C.',            'quote' => 'Everything came out just how I pictured it. I\'ll most definitely be coming back and the service was great!'],
    ['name' => 'Lisa P.',           'quote' => 'Very happy with the service we received from them.'],
    ['name' => 'Mack L.',           'quote' => 'Excellent and professional work. Done within specified timeframe. Priced reasonably too.'],
    ['name' => 'Manuel E.',         'quote' => 'Did the decals on my truck. Came out great. Nicer and cheaper than magnets from Vista Print.'],
    ['name' => 'Marcin B.',         'quote' => 'I got some shirts, signs, and stickers for my business. The customer service was superb. Everything I ordered was good quality and done in a timely manner. Thanks Top 5!'],
    ['name' => 'Marcus R.',         'quote' => 'Super local business. The team at Top 5 Percent got me out of a jam with needing custom product super quick! They over delivered and met my required in hands date. I will highly recommend these folks to other business partners, family, and friends.'],
    ['name' => 'Mark G.',           'quote' => 'This is the second year I have placed an order with Top 5%. I received my order the next day. It was perfect. I would definitely recommend.'],
    ['name' => 'Mark M.',           'quote' => 'Very nice and done on time.'],
    ['name' => 'Matt H.',           'quote' => 'Ezra and Kim are incredible to work with for your personal or business shirts or decals. Highly recommend Top 5 Percent and very reasonable pricing.'],
    ['name' => 'Mildred J.',        'quote' => 'Everything was perfect, great service. My shirts were done quickly and exactly what I asked for.'],
    ['name' => 'Monica P.',         'quote' => 'Excellent customer service! Really good quality DTF prints! Love that it\'s local. Thank you Ezra!'],
    ['name' => 'Nicole W.',         'quote' => 'What a great experience working with Ezra. He was so helpful in figuring out a decal for our business. We will definitely be back if we need anything.'],
    ['name' => 'Patrick M.',        'quote' => 'Excellent work. Couldn\'t be more satisfied.'],
    ['name' => 'R. N.',             'quote' => 'I went to Top 5% for professional fingerprinting. Ezra, aside from being extremely knowledgeable in all things involving printing, has cutting edge printer technology available. From fingerprints to t-shirts, the colors and designs were eye-catching and beautiful. A very cool store!'],
    ['name' => 'Richard G.',        'quote' => 'Excellent service. Reasonable prices.'],
    ['name' => 'Ryan M.',           'quote' => 'Excellent excellent service and products!! Definitely recommend. Quality work! Ezra is great to work with!'],
    ['name' => 'Shane D.',          'quote' => 'Great guy, great communication, quality products.'],
    ['name' => 'Sherri W.',         'quote' => 'I absolutely loved the work that Top 5 Percent did for me. It was exactly what I wanted for the baby shower. The turnaround time was incredible and I look forward to working with your company again.'],
    ['name' => 'Solomon A.',        'quote' => 'Top notch quality! Super fast!! Exceptional service delivery!!!'],
    ['name' => 'Soutane S.',        'quote' => 'Thank you Top 5 Percent for making the shirts for my baby\'s first birthday party. You did an amazing job and your communication from beginning to end was professional and amazing. I will be back.'],
    ['name' => 'Terrance G.',       'quote' => 'Very professional experience and can\'t wait to collaborate more with Top 5%.'],
    ['name' => 'Thomas A.',         'quote' => 'Great guy and he did a great job.'],
    ['name' => 'Toni R.',           'quote' => 'I had a onesie embroidered for our baby announcement and it came out perfect! Was ready in 2 days and very reasonably priced! Will definitely be going back! Thanks Top 5 Percent!'],
...
$firstPage  = array_slice($reviews, 0, 18);
$morePage   = array_slice($reviews, 18);
$totalCount = count($reviews);
@endphp

<x-layouts.page
    title="Customer Reviews | Joliet, IL"
    metaDescription="Read real customer reviews of Top 5 Percent in Joliet, IL. Veteran-owned custom signage and apparel with hundreds of 5-star Google reviews."
    currentPage="about">
    ...
    <section class="py-14 bg-white" x-data="{ showAll: false }">
        <div class="max-w-7xl mx-auto px-6">

            <div class="text-center mb-10">
                <h2 class="text-3xl md:text-4xl font-bold text-charcoal">What Our Customers Are Saying</h2>
                <div class="h-1 w-16 bg-sunburst mx-auto mt-3 mb-4"></div>
                <div class="flex justify-center gap-0.5 mb-3">
                    @for ($i = 0; $i < 5; $i++)
                        <svg class="w-6 h-6 text-sunburst fill-current" viewBox="0 0 20 20">
            ...
            {{-- First 18 reviews always visible --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($firstPage as $review)
            ...
            <div class="text-center mt-10">
                <button
                    @click="showAll = !showAll; if(!showAll) { $el.scrollIntoView({ behavior: 'smooth', block: 'center' }); }"
                    class="inline-flex items-center gap-2 px-8 py-3 bg-charcoal text-sunburst font-bold hover:bg-charcoal-dark hover:shadow-lg transition-all hover:-translate-y-0.5"
                >
                    <span x-text="showAll ? 'Show Fewer Reviews' : 'Show More Reviews'">Show More Reviews</span>
                    <svg
