...
<x-layouts.page
    ...
    <x-sections.cta-quadruple-button-banner />
        ...
        >
            <p class="mb-4">We print custom vinyl banners for businesses of all sizes in Joliet and across the greater Chicagoland area. A well designed banner hanging in front of your store or mounted to your event booth immediately tells customers who you are and what you offer. We use wide format printing technology and eco solvent ink to produce banners with vivid, saturated colors that hold up outdoors for years. Our vinyl banners are grommeted and hemmed on all sides so they hang flat and stay in place even on windy days.</p>
            <p class="mb-4">We serve small businesses, large companies, and everything in between. Whether you need a single banner for your front window or a full set of banners for an outdoor trade show display, we have the capacity to handle your order. We offer custom sizes so you are never stuck with a banner that does not fit your space. Tell us the dimensions you need and we will print a banner that fits perfectly.</p>
        ...
        <x-sections.card-image-with-text
            ...
            imagePosition="right"
        >
            <p class="mb-4">Vinyl banners are one of the most versatile signage products available. You can hang them indoors or outdoors, use them for temporary promotions or permanent displays, and customize every inch of the design. We print full color vinyl banners that showcase your logo, your message, and your brand colors in stunning detail. No matter how complex your design is, our wide format printers can reproduce it with sharp edges and true to life colors.</p>
            <p class="mb-4">We produce banners in any size from small table top formats to large format banners that span an entire building facade. Many of our customers in Joliet and Romeoville use large banners to announce grand openings, seasonal sales, and community events. These banners go up fast and create instant visibility for your business or organization. We also offer indoor fabric banners for clients who need a premium look for trade shows or corporate presentations.</p>
