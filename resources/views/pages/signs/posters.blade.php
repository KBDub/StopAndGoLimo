...
<x-layouts.page
    ...
    <x-sections.cta-quadruple-button-banner />
        ...
        >
            <p class="mb-4">We produce high quality poster prints for businesses, events, and personal use throughout the Joliet and Will County area. Our wide format printers can produce stunning poster prints in a wide range of sizes. We use eco solvent ink on premium semi gloss poster paper as our standard, which gives you sharp images, true to life colors, and a professional finish that stands out on any wall. We also carry matte and gloss paper stocks for customers who need a specific finish for their project.</p>
            <p class="mb-4">We print posters for a wide range of customers including restaurants, retailers, salons, event planners, schools, and nonprofits. Whether you need a single poster for a promotion or a set of identical posters to distribute across multiple locations, we handle both. We offer free design assistance with every order so you do not need to have a final ready to print file before calling us. Our design team will work with you to build a layout that gets your message across clearly and looks great on paper.</p>
        ...
        <x-sections.card-image-with-text
            ...
            imagePosition="right"
        >
            <p class="mb-4">We specialize in large format poster printing for customers who need big, bold displays. Large posters are perfect for grand opening announcements, event backdrops, in store promotions, and any application where you need to make a strong visual impact. A large poster printed in full color commands attention in a way that smaller prints simply cannot. We serve businesses and event organizers in Joliet, Shorewood, Romeoville, and the surrounding Chicagoland area with large format poster output that rivals what you would get from much bigger shops.</p>
            <p class="mb-4">Our printers can produce wide format output for backdrops used at proms, sweet sixteen parties, birthday celebrations, and school events. Large poster backdrops are a budget friendly alternative to fabric step and repeat banners and they are great for one time use events where you want professional quality without a premium price. We mount your large poster prints to foam board or poster board if you need a rigid display that stands on its own or hangs flat on a wall.</p>
        ...
        >
            <p class="mb-4">We make the design process easy for our poster customers. You can use our free online designer to build your own poster from scratch, or you can bring in your own ready to print file. If you have an idea but do not know how to execute it, our in house design team is available to help. We offer 10 minutes of free design time with every order and most poster layouts can be built in that time or less. For more complex projects, we charge a reasonable design fee and will work with you through as many revisions as needed to get the result right.</p>
            <p class="mb-4">We carry a variety of paper types so you can get the finish that best suits your project. Our standard semi gloss stock produces crisp, vibrant images that work well for most poster applications. Matte paper is ideal for flat color graphics and text heavy layouts that would otherwise reflect too much light. Gloss paper delivers the most saturated colors and is the best choice for portrait photography and detailed artwork.</p>
