...
<x-layouts.page
    ...
    >
        ...
        <p><a href="/" class="link-notification">Top 5 Percent</a> produces table cloths in fitted, throw, and stretch styles depending on your preference and the look you want to achieve. Call us at <a href="tel:+18153498600" class="link-notification">(815) 349-8600</a> or visit 121 Springfield Avenue in Joliet to discuss your custom table cloth order today.</p>
    </x-sections.card-image-with-text>
    ...
    <x-sections.card-image-with-text
        ...
        imagePosition="right"
    >
        <p class="mb-4">We offer three main table cover styles to match different booth setups and aesthetic preferences. Fitted table covers hug the table edges precisely for a clean, tailored look, and many exhibitors layer a <a href="/signs/table-signs/table-runners" class="link-notification">custom table runner</a> on top of a fitted cover for a polished, branded presentation that turns heads from across the room. Throw-style table cloths drape naturally over all four sides of the table and are the most versatile option, working equally well on tables of slightly different sizes. Stretch table covers fit snugly like a sleeve over the table for a sleek, modern look without any excess fabric, and they coordinate beautifully with <a href="/signs/business-signs/banners" class="link-notification">retractable banner stands</a> for a complete branded booth setup.</p>
        <p class="mb-4">We also produce custom <a href="/signs/table-signs/table-runners" class="link-notification">table runners</a>, which are narrower printed panels that run lengthwise down the center of your table. Table runners work well in combination with a solid-color table cover or as a standalone accent on a banquet table. They are popular for formal events, catered functions, and any setting where you want branded table presence without completely covering the table surface.</p>
        <p class="mb-4">Table cloths work especially well when they match the brand colors of your team's <a href="/custom-apparel/group-wear/corporate-wear-shirts" class="link-notification">corporate wear</a>, a unified look from shirts to table covering makes every event feel polished and intentional. Need a professional logo for your table cloth design? Our <a href="/design-services/logo-design" class="link-notification">logo design</a> team creates print-ready vector artwork sized for any surface.</p>
        <p>All of our table cover and runner products are portable and easy to store between events. They fold compactly and can be stored in a small bag or box, making them ideal for businesses and organizations that exhibit at multiple events throughout the year. Call us at <a href="tel:+18153498600" class="link-notification">(815) 349-8600</a> to discuss your table cloth or runner order today.</p>
    </x-sections.card-image-with-text>
    ...
    >
        <x-slot name="intro">
            ...
            <h3 class="text-h3 font-bold text-charcoal mb-2">Your Table Cloth Is Visible From Across the Room</h3>
            <p class="mb-4">A standard six-foot table cover has approximately twelve square feet of printable surface area, more than most banner stands. That amount of branded real estate, positioned at knee-to-table height, is visible from a significant distance in any event venue. Your logo, your business name, your tagline, and your color scheme displayed on a high-quality custom table cloth can be seen from across the room and draws attendees to your table before they are close enough to read your other marketing materials.</p>
        </x-slot>
        <x-slot name="mid">
            <h3 class="text-h3 font-bold text-charcoal mb-2">Complete Your Exhibit Display Package</h3>
            <p class="mb-4">A table cloth is a foundational component of any professional event display, and it works best when it is coordinated with your other exhibit elements. When your table cloth, <a href="/signs/business-signs/banners" class="link-notification">banner stand</a>, and collateral materials all use the same colors, logo placement, and visual style, your booth communicates a level of brand consistency that builds credibility and trust. We produce banner stands, retractable banners, table cloths, <a href="/signs/table-signs/table-runners" class="link-notification">table runners</a>, pop-up displays, and event print collateral, all in-house, so we can produce a complete, coordinated exhibit package for your next event.</p>
            <h3 class="text-h3 font-bold text-charcoal mb-2">Reusable at Every Event</h3>
            <p class="mb-4">Unlike one-time use event materials, a quality custom table cloth is designed for repeated use. Our dye sublimation printed table covers are machine washable and maintain their color vibrancy through many wash-and-use cycles. Most businesses and organizations that invest in a custom table cloth use it at every event they exhibit at throughout the year. The per-event cost of a quality table cloth amortizes to almost nothing over a full event season, making it one of the most economical investments in your marketing toolkit, and many clients pair it with our <a href="/promotional-items" class="link-notification">promotional items</a> for giveaways that keep their brand in customers' hands long after the event ends.</p>
        </x-slot>
        <x-slot name="lower">
            <h3 class="text-h3 font-bold text-charcoal mb-2">Quick Turnaround for Upcoming Events</h3>
        ...
        <x-slot name="footer">
            ...
            <p>Call us at <a href="tel:+18153498600" class="link-notification">(815) 349-8600</a> to discuss your custom table cloth or event display needs today, and ask about adding <a href="/promotional-items" class="link-notification">promotional items</a> to your order for a complete giveaway package that keeps your brand in customers' hands after the event.</p>
        </x-slot>
    </x-sections.card-detailed-info>
