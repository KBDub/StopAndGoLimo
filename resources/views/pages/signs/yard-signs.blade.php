...
<x-layouts.page
    ...
    <x-sections.cta-quadruple-button-banner />
        ...
        >
            <p class="mb-4">We help businesses across Joliet and Will County use yard signs to attract new customers every day. A well placed yard sign near a busy road can reach hundreds of people without any ongoing cost. Whether you run a restaurant, a home service company, or a retail store, yard signs are one of the most cost effective ways to promote your brand in the community. We print your design on durable corrugated plastic that holds up in all weather conditions. Metal stakes are included so you can push your signs into the ground and start advertising the same day you pick them up.</p>
            <p class="mb-4">We keep the process simple. You can bring your own design or use our free online designer to build one from scratch. Our in house graphic team has years of experience creating eye catching yard sign layouts that are easy to read from a distance. Bold colors, clean fonts, and a clear call to action are what make a yard sign work. We know what gets noticed and we will make sure your sign is built to stop people in their tracks.</p>
        ...
        <x-sections.card-image-with-text
            ...
            imagePosition="right"
        >
            <p class="mb-4">We print real estate yard signs and political campaign signs for clients all across the Chicagoland area. Real estate agents in Joliet, Plainfield, New Lenox, and Shorewood count on us to deliver professional signs that help their listings stand out. A real estate yard sign needs to be bold and easy to read at a glance. We use bright whites and strong contrast so your listing information pops from the curb. Whether you need single sided or double sided signs, we have the right product for your needs.</p>
            <p class="mb-4">Political candidates running for local office in Will County also trust us with their yard sign orders. We understand that timing is everything during a campaign. Signs need to be in the ground before the election season heats up. We can produce large quantities of political yard signs quickly so your campaign can hit the ground running. We offer bulk pricing that gets more affordable the larger your order gets. The more signs you put out, the more people see your name and your message.</p>
            <p>We are proud to support local businesses, real estate professionals, and political campaigns that keep our communities moving forward. Real estate agents also use our <a href="/stickers/stickers/standard-stickers-decals" class="link-notification">custom stickers</a> as branded labels on flyers and listing packets. <a href="/vehicle-graphics/vehicle-graphics/vehicle-magnets" class="link-notification">Vehicle magnets</a> are popular with agents who want removable car branding that comes off between listings. Reach out to us today and let us help you stand out in Joliet, Will County, and the entire Chicagoland area.</p>
        </x-sections.card-image-with-text>
