...
<x-layouts.page
    ...
    <x-sections.category-hero
        ...
        description="We print custom yard signs for real estate, political campaigns, business promotions, events, and personal use throughout Joliet, Shorewood, Plainfield, and all of Will County. Durable corrugated plastic, metal stakes, and same day service available."
    ...
    <x-sections.product-grid collectionSlug="yard-signs" parentSlug="signs" />
            ...
            >
                <x-slot name="intro">
                    <p class="mb-4">Yard signs are one of the most direct and affordable ways to get your message in front of local customers in Joliet, Plainfield, Shorewood, Romeoville, and throughout the greater Chicagoland area. A well placed yard sign on a busy corner or in front of a property where work is being done can generate dozens of new inquiries without any ongoing cost once the sign is in the ground. We print custom yard signs for businesses, real estate agents, political campaigns, contractors, event organizers, and community groups all across Will County, and many of those clients also order matching <a href="/signs/business-signs/banners" class="link-notification">banners</a> to anchor their event signage package. Here is how to get the most out of your yard sign investment.</p>
                ...
                <x-slot name="lower">
                    ...
                    <p class="mb-4">Yard signs serve businesses in almost every industry across the Chicagoland area. Contractors, landscapers, and home service providers use them to generate referrals in the neighborhoods where they are actively working, and they often pair yard signs with <a href="/vehicle-graphics" class="link-notification">vehicle graphics</a> to create a cohesive brand presence across every job site. Real estate agents use them to advertise listings and open houses throughout Will County, and political candidates use them to build name recognition, with many also ordering branded <a href="/custom-apparel/group-wear/spirit-wear-shirts" class="link-notification">spirit wear</a> for their volunteer teams.</p>
                ...
                <x-slot name="footer">
                    <p class="mb-4">We print corrugated plastic yard signs in full color using UV resistant inks that hold up through Illinois weather without fading or peeling. We offer single sided and double sided printing, optional metal H-stakes for easy installation, and bulk pricing that rewards larger orders, and clients who need a complete outdoor package can add <a href="/signs/business-signs/banners" class="link-notification">vinyl banners</a> to their yard sign order for a coordinated street presence. Same day printing is available on select sizes so even last minute campaigns can be covered, and for event-day branding our <a href="/custom-apparel/printing-options/dtf-transfers" class="link-notification">DTF transfer shirts</a> are available same-day as well.</p>
                    <p>We are a veteran owned business in Joliet, Illinois and we are proud to produce signs for the businesses and community members who make Will County a great place to live and work. Call us at (815) 349 8600 or stop by 121 Springfield Avenue in Joliet, and ask about bundling your yard signs with matching <a href="/signs/business-signs/door-signs" class="link-notification">door signs</a> or window graphics for a complete first impression.</p>
                </x-slot>
            </x-sections.card-detailed-info>
