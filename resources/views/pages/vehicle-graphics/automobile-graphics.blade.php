...
<x-layouts.page
    ...
    <x-sections.cta-quadruple-button-banner />
        ...
        >
            <p class="mb-4">We design and install custom car wraps and vinyl lettering for vehicles of all types throughout Joliet, Shorewood, and Will County. A professionally wrapped vehicle does something no other form of advertising can do: it moves with you. Every time you drive to a job site, park outside a client meeting, or travel through the Chicagoland area, your vehicle is working as a mobile billboard reaching thousands of people without any recurring cost. According to industry research, vehicle graphics generate more impressions per dollar than any other form of local advertising, including digital ads and billboards.</p>
            <p class="mb-4">We offer full wraps and partial wraps depending on your budget and your goals. A full wrap covers the entire exterior of your vehicle in printed vinyl and gives you the most dramatic, eye catching result. A partial wrap covers key sections like the doors, hood, or rear panel and still delivers a powerful branded look at a lower investment. For businesses that want a clean professional appearance without full coverage, vinyl lettering applied to the doors and tailgate area accomplishes a lot with a simple design. We work with you to find the right option for your vehicle and your budget.</p>
        ...
        <x-sections.card-image-with-text
            ...
            imagePosition="right"
        >
            <p class="mb-4">We specialize in commercial van lettering and fleet vehicle branding for service businesses throughout Joliet, Crest Hill, and Will County. A plain white work van is a missed opportunity. When your van is parked outside a customer's home in Plainfield or traveling down Route 30 through Shorewood, every person who sees it is a potential new customer. Adding your company name, phone number, logo, and a short list of services in bold vinyl lettering turns a plain vehicle into a powerful advertising tool that works every single hour it is on the road or parked in a visible location.</p>
            <p class="mb-4">We work with plumbers, electricians, landscapers, HVAC technicians, cleaning services, and dozens of other trades and service companies in Will County. These businesses understand that their vehicles travel through neighborhoods all day and that vehicle graphics are the most cost effective way to generate local name recognition. One of our customers reported picking up three new clients within two days of having his van lettered by our team. That kind of return on investment is hard to match with any other marketing tool.</p>
        ...
        >
            <p class="mb-4">We print and install custom boat graphics and marine vinyl decals for watercraft owners throughout Joliet, Shorewood, Crest Hill, and Will County. Vehicle graphics are not just for cars and trucks. Your boat spends time on the water where it is visible to everyone at the marina and everyone else on the lake. A custom boat graphic with your boat name, a unique design, or your business branding makes your vessel stand out and look sharp on the water. We use marine grade vinyl that is specifically formulated to withstand constant exposure to water, humidity, UV light, and the stresses that come with a watercraft environment.</p>
            <p class="mb-4">Marine vinyl is fundamentally different from standard automotive vinyl. It uses a stronger adhesive that bonds to fiberglass, aluminum, and painted boat hull surfaces and resists the constant wet and dry cycles that would cause standard vinyl to lift or peel. The ink system we use is also UV stabilized so your colors stay bright season after season even with constant sun exposure on the water. We do not want your boat graphics floating next to your boat. They should stay attached and looking great for years.</p>
