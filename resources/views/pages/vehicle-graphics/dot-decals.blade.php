...
<x-layouts.page
    ...
    <x-sections.category-hero
        ...
        description="We print DOT decals, USDOT number stickers, MC number decals, truck lettering, and commercial vehicle compliance graphics for truckers and fleet operators in Joliet, Shorewood, Channahon, and all of Will County. Veteran owned with real trucking experience. Same day service available."
    ...
    <x-sections.cta-quadruple-button-banner />
        ...
        >
            ...
            <p>We print DOT decals the same day in most cases because we understand that a truck sitting in the yard waiting for compliance stickers is a truck that is not earning. We are located at 121 Springfield Avenue in Joliet and we serve truckers and fleet operators from across Will County including Channahon, Minooka, Braidwood, and all the way out to Kankakee. Call us at (815) 349 8600 before you head over and we will have your order ready to go as quickly as possible.</p>
        </x-sections.card-image-with-text>
